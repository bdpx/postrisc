...
export CLANG_PATH="/home/user/risc/llvm-build-debug/bin"
...
declare -a COPTIONS=(
    ...
    -isystem /home/user/risc/glibc_headers
    ...
    -mcpu=pv1
    --gcc-toolchain=/home/user/risc/llvm-build/bin
...
../glibc/configure \
  ...
  --prefix=/home/user/risc/glibc_$ARCH/usr \
  --exec-prefix=/home/user/risc/glibc_$ARCH/usr \
  --disable-werror \
  --with-clang \
  --with-lld \
  --disable-multi-arch
