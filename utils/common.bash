...
LLVM_BUILD_BIN_DIR="${LLVM_BUILD_DIR}/bin"
#echo "LLVM_BUILD_BIN_DIR=${LLVM_BUILD_BIN_DIR}"
...
#########################################################################################
CLANG=${LLVM_BUILD_BIN_DIR}/clang
CLANGPP=${LLVM_BUILD_BIN_DIR}/clang++
LLC=${LLVM_BUILD_BIN_DIR}/llc
ASSEMBLER=${LLVM_BUILD_BIN_DIR}/llvm-mc
OBJDUMP=${LLVM_BUILD_BIN_DIR}/llvm-objdump
LINKER=${LLVM_BUILD_BIN_DIR}/ld.lld
TABLEGEN=${LLVM_BUILD_BIN_DIR}/llvm-tblgen
