...
void
CTestController::writeTestsPerformed(u64 count)
{
    if ( is_cout_tty )
       std::cout << '\r';
...
void
CTestController::checkEarlyExit(u64& count)
{
...
template<>
void
CTestController::next<i32>(i32 & a)
{
...
template<>
void
CTestController::next<i64>(i64 & a)
{
    switch(CASE(level, subcase)) {
        case CASE(1,0):
        case CASE(2,0):
