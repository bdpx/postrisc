...
u32
CSequence::u32_p1(u8 nbits, u16 index)
{
...
void
CSequence::RandomP3(i32 & z)
{
    z = u32_p1(32) + u32_p1(32) + u32_p1(32);
}

void
CSequence::RandomPInf(i32 & z)
{
    int n = random8() % 29;
    u32 mask = -u32(1) >> n;
...
void
CSequence::RandomP3(i64 & z)
{
    z = u64_p1(64) + u64_p1(64) + u64_p1(64);
}

void
CSequence::RandomPInf(i64 & z)
{
    int n = random8() % 61;
    u64 mask = -u64(1) >> n;
...
size_t
CSequence::GetTotal(int level, i32 & )
{
    return level == 1 ? 3 * i32NumP1 : 2 * i32NumP2;
}

size_t
CSequence::GetTotal(int level, i64 & )
{
