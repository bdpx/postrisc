...
#define DECLARE_HARDWARE_FUNCTIONS_TABLE(X) \
    ...
    X(f1, i_f,    BOTH, 0, 0, 0, 0,  int32_t,   f80,   to_f80) \
    X(f1, i_f,    BOTH, 0, 0, 0, 0,  int64_t,   f80,   to_f80) \
    X(f1, f_i,    BOTH, 0, 1, 0, 0,  f80,       int32_t,   to_i32) \
    X(f1, f_i,    BOTH, 0, 0, 0, 0,  f80,       int32_t,   to_i32_round_to_zero) \
    X(f1, f_i,    BOTH, 0, 1, 0, 0,  f80,       int64_t,   to_i64) \
    X(f1, f_i,    BOTH, 0, 0, 0, 0,  f80,       int64_t,   to_i64_round_to_zero) \
...
#define DECLARE_FUNCTIONS_TABLE(X) \
    ...
    X(f1, i_f,    BOTH, 0, 0, 0, 0,  int32_t,   f256,  to_f256) \
    X(f1, i_f,    BOTH, 0, 0, 0, 0,  int64_t,   f256,  to_f256) \
    ...
    X(f1, f_i,    BOTH, 0, 1, 0, 0,  f256,      int32_t,   to_i32) \
    X(f1, f_i,    BOTH, 0, 0, 0, 0,  f256,      int32_t,   to_i32_round_to_zero) \
    X(f1, f_i,    BOTH, 0, 1, 0, 0,  f256,      int64_t,   to_i64) \
    X(f1, f_i,    BOTH, 0, 0, 0, 0,  f256,      int64_t,   to_i64_round_to_zero) \
    ...
    X(f1, i_f,    BOTH, 0, 0, 0, 0,  int32_t,   f512,  to_f512) \
    X(f1, i_f,    BOTH, 0, 0, 0, 0,  int64_t,   f512,  to_f512) \
    ...
    X(f1, f_i,    BOTH, 0, 1, 0, 0,  f512,  int32_t,   to_i32) \
    X(f1, f_i,    BOTH, 0, 0, 0, 0,  f512,  int32_t,   to_i32_round_to_zero) \
    X(f1, f_i,    BOTH, 0, 1, 0, 0,  f512,  int64_t,   to_i64) \
    X(f1, f_i,    BOTH, 0, 0, 0, 0,  f512,  int64_t,   to_i64_round_to_zero) \
