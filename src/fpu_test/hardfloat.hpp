...
//    void set_flush_to_zero(bool val);
    ...
    i32 to_i32( f128 a ) {  return   (i32)F128_FUNC_NAME(rint)( a.hard() ); } // cant fint i32rint
    i64 to_i64( f128 a ) {  return   (i64)F128_FUNC_NAME(rint)( a.hard() ); }
    ...
    f128 round_to_int( f128 a ) {  return f128::make( (native::f128)(i64)F128_FUNC_NAME(rint)( a.hard() ) ); }
...
//    f128 exp2( f128 a ) { f128 z;  z.hard() = ::exp2q( a.hard() );   return z; }
    ...
    f128 log2( f128 a ) { return f128::make( (native::f128)F128_FUNC_NAME(log2)( a.hard() ) ); }
    ...
    f128 sqrt( f128 a ) { return f128::make( (native::f128)F128_FUNC_NAME(sqrt)( a.hard() ) ); }
    ...
    f128 rem( f128 a, f128 b ) {  return f128::make( (native::f128)F128_FUNC_NAME(remainder)( a.hard(), b.hard() ) ); }
    ...
    f128 muladd( f128 a, f128 b, f128 c, muladd_negate_t ) {   return f128::make( (native::f128)F128_FUNC_NAME(fma)( a.hard(), b.hard(), c.hard() ) ); }
