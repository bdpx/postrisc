...
//    void set_flush_to_zero(bool val);
    ...
    f32  to_f32 ( i32 a ) {  return f32::make( float    ( a ) ); }
    f64  to_f64 ( i32 a ) {  return f64::make( double   ( a ) ); }
    f80  to_f80 ( i32 a ) {  return f80::make( extended ( a ) ); }
    f128 to_f128( i32 a ) {  return f128::make( quadruple( a ) ); }

    f32  to_f32 ( i64 a ) {  return f32::make( float    ( a )); }
    f64  to_f64 ( i64 a ) {  return f64::make( double   ( a )); }
    f80  to_f80 ( i64 a ) {  return f80::make( extended ( a )); }
    f128 to_f128( i64 a ) {  return f128::make( quadruple( a )); }

    f64  to_f64 ( f32  a ) {  return f64::make( double   ( a.hard() )); }
    f80  to_f80 ( f32  a ) {  return f80::make( extended ( a.hard() )); }
    f128 to_f128( f32  a ) {  return f128::make( quadruple( a.hard() )); }
    f32  to_f32 ( f64  a ) {  return f32::make( float    ( a.hard() )); }
    f80  to_f80 ( f64  a ) {  return f80::make( extended ( a.hard() )); }
    f128 to_f128( f64  a ) {  return f128::make( quadruple( a.hard() )); }
    f32  to_f32 ( f80  a ) {  return f32::make( float    ( a.hard() )); }
    f64  to_f64 ( f80  a ) {  return f64::make( double   ( a.hard() )); }
    f128 to_f128( f80  a ) {  return f128::make( quadruple( a.hard() )); }
    f32  to_f32 ( f128 a ) {  return f32::make( float    ( a.hard() )); }
    f64  to_f64 ( f128 a ) {  return f64::make( double   ( a.hard() )); }
    f80  to_f80 ( f128 a ) {  return f80::make( extended ( a.hard() )); }
...
#if USE_QUADMATH
    f128 round_to_int( f128 a ) {  return f128::make( (quadruple)(i64)rintq( a.hard() ) ); }
#else
    f128 round_to_int( f128 a ) {  return f128::make( (quadruple)(i64)mpfr::rint( a.hard() ) ); }
#endif
...
#if USE_QUADMATH
    f128 log2( f128 a ) { return f128::make( (quadruple)log2q( a.hard() ) ); }
#else
    f128 log2( f128 a ) { return f128::make( (quadruple)mpfr::log2( a.hard() ) ); }
#endif
...
#if USE_QUADMATH
    f128 sqrt( f128 a ) { return f128::make( (quadruple)sqrtq( a.hard() ) ); }
#else
    f128 sqrt( f128 a ) { return f128::make( (quadruple)mpfr::sqrt( a.hard() ) ); }
#endif
...
#if USE_QUADMATH
    f128 rem( f128 a, f128 b ) {  return f128::make( (quadruple)remainderq( a.hard(), b.hard() ) ); }
#else
    f128 rem( f128 a, f128 b ) {  return f128::make( (quadruple)mpfr::remainder( a.hard(), b.hard() ) ); }
#endif
...
#if USE_QUADMATH
    f128 muladd( f128 a, f128 b, f128 c, muladd_negate_t ) {   return f128::make( (quadruple)fmaq( a.hard(), b.hard(), c.hard() ) ); }
#else
    f128 muladd( f128 a, f128 b, f128 c, muladd_negate_t ) {   return f128::make( (quadruple)mpfr::fma( a.hard(), b.hard(), c.hard() ) ); }
#endif
