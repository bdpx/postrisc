...
X80(unsigned sign, int exponent)
{
    return ( uint16_t(sign) << 15 )
           | uint16_t( (exponent) + f80::BIAS );
}

static const uint16_t f80_nonfraction[] =
{
...
void
CSequence::NextP1(f80 & z)
{
    static const uint64_t f80P1[] = {
...
template<>
uint64_t
CSequence::WeightExponent<f80>(void)
{
    static const struct {
        uint16_t  mask;
        uint16_t  offset;
...
size_t
CSequence::GetTotal(int level, f80 &)
{
    return level == 1 ? 3 * f80_num_nonfractionP1 : 2 * f80_num_nonfractionP2;
}

size_t
CSequence::GetTotal(int level, f80 &, f80 &)
{
...
BOOST_AUTO_TEST_CASE(test_f80_snan)
{
    static const struct {
        ...
        { false, f80(UINT16_C(0x7fff), UINT64_C(0xcca4224224fb0249)) },
        { false, f80(UINT16_C(0x7fff), UINT64_C(0xfe0000003ffffffe)) },
        { false, f80(UINT16_C(0xffff), UINT64_C(0xcca4224224fb0249)) },
        { false, f80(UINT16_C(0xffff), UINT64_C(0xfe0000003ffffffe)) },
        {  true, f80(UINT16_C(0x7fff), UINT64_C(0xae0000003ffffffe)) },
        {  true, f80(UINT16_C(0xffff), UINT64_C(0xae0000003ffffffe)) },
    };

    BOOST_TEST(f80::EINF == 0x7fff);
