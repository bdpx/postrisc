...
i32 CTestFPU::to_i32_round_to_zero( f32 a )
{
...
i64 CTestFPU::to_i64_round_to_zero( f32 a )
{
    rounding_mode_t savedRoundingMode = get_rounding_mode();
    set_rounding_mode(FLOAT_ROUND_TOWARDZERO);
...
i32 CTestFPU::to_i32_round_to_zero( f64 a )
{
    rounding_mode_t savedRoundingMode = get_rounding_mode();
    set_rounding_mode( FLOAT_ROUND_TOWARDZERO);
    i32 z = to_i32( floatX(a) );
...
i64 CTestFPU::to_i64_round_to_zero( f64 a )
{
    rounding_mode_t savedRoundingMode = get_rounding_mode();
    set_rounding_mode( FLOAT_ROUND_TOWARDZERO);
    i64 z = to_i64( floatX(a) );
...
i32 CTestFPU::to_i32_round_to_zero( f80 a )
{
    rounding_mode_t savedRoundingMode = get_rounding_mode();
    set_rounding_mode( FLOAT_ROUND_TOWARDZERO);
    i32 z = to_i32( floatX(a) );
...
i64 CTestFPU::to_i64_round_to_zero( f80 a )
{
    rounding_mode_t savedRoundingMode = get_rounding_mode();
    set_rounding_mode( FLOAT_ROUND_TOWARDZERO);
    i64 z = to_i64( floatX(a) );
...
i32 CTestFPU::to_i32_round_to_zero( f128 a )
{
    rounding_mode_t savedRoundingMode = get_rounding_mode();
    set_rounding_mode( FLOAT_ROUND_TOWARDZERO);
    i32 z = to_i32( floatX(a) );
...
i64 CTestFPU::to_i64_round_to_zero( f128 a )
{
    rounding_mode_t savedRoundingMode = get_rounding_mode();
    set_rounding_mode(FLOAT_ROUND_TOWARDZERO);
    i64 z = to_i64( floatX(a) );
...
i32 CTestFPU::to_i32_round_to_zero( f256 a )
{
    rounding_mode_t savedRoundingMode = get_rounding_mode();
    set_rounding_mode( FLOAT_ROUND_TOWARDZERO);
    i32 z = to_i32( floatX(a) );
...
i64 CTestFPU::to_i64_round_to_zero( f256 a )
{
    rounding_mode_t savedRoundingMode = get_rounding_mode();
    set_rounding_mode(FLOAT_ROUND_TOWARDZERO);
    i64 z = to_i64( floatX(a) );
...
i32 CTestFPU::to_i32_round_to_zero( f512 a )
{
    rounding_mode_t savedRoundingMode = get_rounding_mode();
    set_rounding_mode( FLOAT_ROUND_TOWARDZERO);
...
i64 CTestFPU::to_i64_round_to_zero( f512 a )
{
    rounding_mode_t savedRoundingMode = get_rounding_mode();
    set_rounding_mode(FLOAT_ROUND_TOWARDZERO);
