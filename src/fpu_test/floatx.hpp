...
public:
    ...
    explicit floatX(int32_t);
    explicit floatX(int64_t);
    explicit floatX(f32);
    explicit floatX(f64);
    explicit floatX(f80);
...
class CTestFPU : public CBaseFPU {
private:
    ...
    int32_t to_i32(floatX);
    int64_t to_i64(floatX);
    f32 to_f32(floatX);
    f64 to_f64(floatX);
    f80 to_f80(floatX);
    f128 to_f128(floatX);
...
public:
    ...
    f32 to_f32( int32_t a ) {  return to_f32( floatX(a) );  }
    f64 to_f64( int32_t a ) {  return to_f64( floatX(a) );  }
    f80 to_f80( int32_t a ) {  return to_f80( floatX(a) );  }
    f128 to_f128( int32_t a ) {  return to_f128( floatX(a) );  }
    f256 to_f256( int32_t a ) {  return to_f256( floatX(a) ); }
    f512 to_f512( int32_t a ) {  return to_f512( floatX(a) ); }

    f32 to_f32( int64_t a ) {  return to_f32( floatX(a) );  }
    f64 to_f64( int64_t a ) {  return to_f64( floatX(a) );  }
    f80 to_f80( int64_t a ) {  return to_f80( floatX(a) );  }
    f128 to_f128( int64_t a ) {  return to_f128( floatX(a) );  }
    f256 to_f256( int64_t a ) {  return to_f256( floatX(a) ); }
    f512 to_f512( int64_t a ) {  return to_f512( floatX(a) ); }

    int32_t to_i32( f32 a ) {  return to_i32( floatX(a) );  }
    int64_t to_i64( f32 a ) {  return to_i64( floatX(a) );  }
    int32_t to_i32( f64 a ) {  return to_i32( floatX(a) );  }
    int64_t to_i64( f64 a ) {  return to_i64( floatX(a) );  }
    int32_t to_i32( f80 a ) {  return to_i32( floatX(a) );  }
    int64_t to_i64( f80 a ) {  return to_i64( floatX(a) );  }
    int32_t to_i32( f128 a ) {  return to_i32( floatX(a) );  }
    int64_t to_i64( f128 a ) {  return to_i64( floatX(a) );  }
    int32_t to_i32( f256 a ) {  return to_i32( floatX(a) );  }
    int64_t to_i64( f256 a ) {  return to_i64( floatX(a) );  }
    int32_t to_i32( f512 a ) {  return to_i32( floatX(a) );  }
    int64_t to_i64( f512 a ) {  return to_i64( floatX(a) );  }
