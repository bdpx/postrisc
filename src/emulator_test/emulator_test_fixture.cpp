...
void
emulator_test_fixture::test_binop(EInstructionID insn, const TestData_binop& data)
{
...
void
emulator_test_fixture::test_binimm(EInstructionID insn, const TestData_binimm& data)
{
    std::ostringstream program;

    program << ".text" << fmt::endl
            << "   alloc 5\n"
            << "   " << insn << "    %r3, %r1, 0x" << fmt::hex(data.imm) << fmt::endl
            << "   halt" << fmt::endl
            << ".end" << fmt::endl;
...
void
emulator_test_fixture::test_bin_shamt(EInstructionID insn, const TestData_RaAssignRbShamt& data)
{
    std::ostringstream program;

    program << ".text" << fmt::endl
            << "   alloc 5\n"
            << "   " << insn << "    %r3, %r1, " << data.shamt << fmt::endl
            << "   halt" << fmt::endl
            << ".end" << fmt::endl;
...
void
emulator_test_fixture::test_clmul(const TestData_clmul& data)
{
    std::ostringstream program;

    program << ".text" << fmt::endl
            << "   alloc 5\n"
            << "   clmul %r3, %r1, %r2, " << data.scale << fmt::endl
            << "   halt" << fmt::endl
            << ".end" << fmt::endl;
...
void
emulator_test_fixture::test_compare_and_branch(EInstructionID insn, const TestData_CompareAndBranch& data)
{
    std::ostringstream program;
...
void
emulator_test_fixture::TestCompareWithZeroAndBranch(EInstructionID insn, const TestData_CompareWithZeroAndBranch& data)
{
    std::ostringstream program;
