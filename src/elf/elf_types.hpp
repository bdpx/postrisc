...
enum ElfOsAbi : unsigned char {
    ...
    ELFOSABI_NUXI    = 17, // Nuxi CloudABI
    ELFOSABI_OPENVOS = 18, // Stratus Technologies OpenVOS
    ELFOSABI_ARM     = 97, // ARM
    // 64-255 Architecture-specific value range 
    ELFOSABI_AMDGPU_HSA = 64, // AMDGPU OS for HSA compatible compute kernels
    ELFOSABI_AMDGPU_PAL = 65, // AMDGPU OS for AMD PAL compatible graphics shaders and compute kernels
    ELFOSABI_AMDGPU_MESA3D = 66, // AMDGPU OS for Mesa3D compatible graphics shaders and compute kernels
