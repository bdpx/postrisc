...
{
    Decoder decoder;
    m_DirectivesPCRE = QRegularExpression(QString::fromStdString(std::string("\\.") + ComputePattern(CAssembler::asm_directives)));
...
std::string
AssemblerHighLighter::ComputePattern(const keywordmap& _keywordmap)
{
