...
const Decoder::TInstructionMnemonicTable<(1 << bits_per_indexed_opx)>  Decoder::arch_info_indexed_ds = LAMBDA_INITIALIZER(bits_per_indexed_opx,   DECLARE_INDEXED_DS_EXTENDED_OPCODES);
const Decoder::TInstructionMnemonicTable<(1 << bits_per_indexed_opx)>  Decoder::arch_info_indexed_ws = LAMBDA_INITIALIZER(bits_per_indexed_opx,   DECLARE_INDEXED_WS_EXTENDED_OPCODES);
const Decoder::TInstructionMnemonicTable<(1 << bits_per_indexed_opx)>  Decoder::arch_info_indexed_wz = LAMBDA_INITIALIZER(bits_per_indexed_opx,   DECLARE_INDEXED_WZ_EXTENDED_OPCODES);
...
const Decoder::regname_array Decoder::spr_names =
    []() constexpr -> auto {
        Decoder::regname_array arr = {};
#define SET_SPECIAL_REGISTER(value, name, regclass, descr) \
