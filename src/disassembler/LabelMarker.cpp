...
#define CASE(NAME) case insn_##NAME:
    ...
    CASE(br_bc) CASE(br_bs) CASE(br_bc_imm) CASE(br_bs_imm)
    CASE(br_eq_i64) CASE(br_ne_i64) CASE(br_lt_i64) CASE(br_le_i64) CASE(br_lt_u64) CASE(br_le_u64)
    CASE(br_eq_i32) CASE(br_ne_i32) CASE(br_lt_i32) CASE(br_le_i32) CASE(br_lt_u32) CASE(br_le_u32)
    CASE(eh_next) CASE(eh_catch)
    CASE(br_eq_imm_i64) CASE(br_ne_imm_i64) CASE(br_lt_imm_i64) CASE(br_lt_imm_u64) CASE(br_ge_imm_i64) CASE(br_ge_imm_u64)
    CASE(br_eq_imm_i32) CASE(br_ne_imm_i32) CASE(br_lt_imm_i32) CASE(br_lt_imm_u32) CASE(br_ge_imm_i32) CASE(br_ge_imm_u32)
    CASE(br_mask_all) CASE(br_mask_notall) CASE(br_mask_none) CASE(br_mask_any)
