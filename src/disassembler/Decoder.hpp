...
public:
    ...
    static const TInstructionMnemonicTable<bits_per_indexed_opx>  arch_info_mem_xi64;
    static const TInstructionMnemonicTable<bits_per_indexed_opx>  arch_info_mem_xu64;
    static const TInstructionMnemonicTable<bits_per_indexed_opx>  arch_info_mem_xi32;
    static const TInstructionMnemonicTable<bits_per_indexed_opx>  arch_info_mem_xu32;

    static const TInstructionMnemonicTable<bits_per_indexed_opx>  arch_info_fma_f16;
    static const TInstructionMnemonicTable<bits_per_indexed_opx>  arch_info_fma_f32;
    static const TInstructionMnemonicTable<bits_per_indexed_opx>  arch_info_fma_f64;
    static const TInstructionMnemonicTable<bits_per_indexed_opx>  arch_info_fma_f128;

    static const TInstructionMnemonicTable<bits_per_branch_opx>   arch_info_br_misc;
    static const TInstructionMnemonicTable<bits_per_branch_opx>   arch_info_br_32;
    static const TInstructionMnemonicTable<bits_per_branch_opx>   arch_info_br_64;
    static const TInstructionMnemonicTable<bits_per_branch_opx>   arch_info_br_128;
    // extended subcodes of opcode_fused
    static const TInstructionMnemonicTable<bits_per_branch_opx>   arch_info_nul_misc;
    static const TInstructionMnemonicTable<bits_per_branch_opx>   arch_info_nul_32;
    static const TInstructionMnemonicTable<bits_per_branch_opx>   arch_info_nul_64;
    static const TInstructionMnemonicTable<bits_per_branch_opx>   arch_info_nul_128;
...
template<typename CMD> EInstructionID Decoder::Decode(CMD cmd)
{
    ...
    switch (opcode) {
        ...
        case EInstructionOpcode::opcode_fma_f16:  return arch_info_fma_f16 [ cmd.GetIndexedOpx() ];
        case EInstructionOpcode::opcode_fma_f32:  return arch_info_fma_f32 [ cmd.GetIndexedOpx() ];
        case EInstructionOpcode::opcode_fma_f64:  return arch_info_fma_f64 [ cmd.GetIndexedOpx() ];
        case EInstructionOpcode::opcode_fma_f128: return arch_info_fma_f128[ cmd.GetIndexedOpx() ];
