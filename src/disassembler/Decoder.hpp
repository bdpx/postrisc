...
public:
    ...
    static const TInstructionMnemonicTable<(1 << bits_per_branch_opx)>   arch_info_br_i128;
    static const TInstructionMnemonicTable<(1 << bits_per_branch_opx)>   arch_info_loop;
    static const TInstructionMnemonicTable<(1 << bits_per_branch_opx)>   arch_info_br_f32;
    static const TInstructionMnemonicTable<(1 << bits_per_branch_opx)>   arch_info_br_f64;
    static const TInstructionMnemonicTable<(1 << bits_per_branch_opx)>   arch_info_br_f128;
    ...
    static const TInstructionMnemonicTable<(1 << bits_per_branch_opx)>   arch_info_nul_rr;
    static const TInstructionMnemonicTable<(1 << bits_per_branch_opx)>   arch_info_nul_i128;
    static const TInstructionMnemonicTable<(1 << bits_per_branch_opx)>   arch_info_nul_f32;
    static const TInstructionMnemonicTable<(1 << bits_per_branch_opx)>   arch_info_nul_f64;
    static const TInstructionMnemonicTable<(1 << bits_per_branch_opx)>   arch_info_nul_f128;
...
template<typename CMD> EInstructionID Decoder::Decode(CMD cmd)
{
    ...
    switch (opcode) {
        ...
        case EInstructionOpcode::opcode_fused:
            opx = cmd.GetFusedOpx();
            switch (opx) {
            case opcode_nul_rr:   return arch_info_nul_rr  [ cmd.GetBranchOpx() ];
            case opcode_nul_i128: return arch_info_nul_i128[ cmd.GetBranchOpx() ];
            case opcode_nul_f32:  return arch_info_nul_f32 [ cmd.GetBranchOpx() ];
            case opcode_nul_f64:  return arch_info_nul_f64 [ cmd.GetBranchOpx() ];
            case opcode_nul_f128: return arch_info_nul_f128[ cmd.GetBranchOpx() ];
            default:
        ...
        case EInstructionOpcode::opcode_br_i128: return arch_info_br_i128[ cmd.GetBranchOpx() ];
        case EInstructionOpcode::opcode_loop:    return arch_info_loop   [ cmd.GetBranchOpx() ];
        case EInstructionOpcode::opcode_br_f32:  return arch_info_br_f32 [ cmd.GetBranchOpx() ];
        case EInstructionOpcode::opcode_br_f64:  return arch_info_br_f64 [ cmd.GetBranchOpx() ];
        case EInstructionOpcode::opcode_br_f128: return arch_info_br_f128[ cmd.GetBranchOpx() ];
