...
const Decoder::TInstructionMnemonicTable<(1 << bits_per_branch_opx)>   Decoder::arch_info_br_i128 = LAMBDA_INITIALIZER(bits_per_branch_opx,   DECLARE_BR_I128_EXTENDED_OPCODES);
...
const Decoder::TInstructionMnemonicTable<(1 << bits_per_branch_opx)>   Decoder::arch_info_br_f32  = LAMBDA_INITIALIZER(bits_per_branch_opx,   DECLARE_BR_F32_EXTENDED_OPCODES);
const Decoder::TInstructionMnemonicTable<(1 << bits_per_branch_opx)>   Decoder::arch_info_br_f64  = LAMBDA_INITIALIZER(bits_per_branch_opx,   DECLARE_BR_F64_EXTENDED_OPCODES);
const Decoder::TInstructionMnemonicTable<(1 << bits_per_branch_opx)>   Decoder::arch_info_br_f128 = LAMBDA_INITIALIZER(bits_per_branch_opx,   DECLARE_BR_F128_EXTENDED_OPCODES);
const Decoder::TInstructionMnemonicTable<(1 << bits_per_branch_opx)>   Decoder::arch_info_nul_rr  = LAMBDA_INITIALIZER(bits_per_branch_opx,   DECLARE_NUL_RR_EXTENDED_OPCODES);
const Decoder::TInstructionMnemonicTable<(1 << bits_per_branch_opx)>   Decoder::arch_info_nul_i128= LAMBDA_INITIALIZER(bits_per_branch_opx,   DECLARE_NUL_I128_EXTENDED_OPCODES);
const Decoder::TInstructionMnemonicTable<(1 << bits_per_branch_opx)>   Decoder::arch_info_nul_f32 = LAMBDA_INITIALIZER(bits_per_branch_opx,   DECLARE_NUL_F32_EXTENDED_OPCODES);
const Decoder::TInstructionMnemonicTable<(1 << bits_per_branch_opx)>   Decoder::arch_info_nul_f64 = LAMBDA_INITIALIZER(bits_per_branch_opx,   DECLARE_NUL_F64_EXTENDED_OPCODES);
const Decoder::TInstructionMnemonicTable<(1 << bits_per_branch_opx)>   Decoder::arch_info_nul_f128= LAMBDA_INITIALIZER(bits_per_branch_opx,   DECLARE_NUL_F128_EXTENDED_OPCODES);
