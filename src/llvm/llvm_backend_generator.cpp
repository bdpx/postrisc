...
static void tablegen_opcodes(std::ostream& out)
{
    ...
    // fused subcodes
    tablegen_opcodes<bits_per_branch_opx>  (out, Decoder::arch_info_nul_rr,   "nul_rr_opx");
    tablegen_opcodes<bits_per_branch_opx>  (out, Decoder::arch_info_nul_i128, "nul_i128_opx");
    tablegen_opcodes<bits_per_branch_opx>  (out, Decoder::arch_info_nul_f32,  "nul_f32_opx");
    tablegen_opcodes<bits_per_branch_opx>  (out, Decoder::arch_info_nul_f64,  "nul_f64_opx");
    tablegen_opcodes<bits_per_branch_opx>  (out, Decoder::arch_info_nul_f128, "nul_f128_opx");
    ...
    tablegen_opcodes<bits_per_branch_opx>  (out, Decoder::arch_info_brr,     "brr_opx");
    tablegen_opcodes<bits_per_branch_opx>  (out, Decoder::arch_info_br_i128, "br_i128_opx");
    tablegen_opcodes<bits_per_branch_opx>  (out, Decoder::arch_info_loop,    "loop_opx");
    tablegen_opcodes<bits_per_branch_opx>  (out, Decoder::arch_info_br_f32,  "br_f32_opx");
    tablegen_opcodes<bits_per_branch_opx>  (out, Decoder::arch_info_br_f64,  "br_f64_opx");
    tablegen_opcodes<bits_per_branch_opx>  (out, Decoder::arch_info_br_f128, "br_f128_opx");
