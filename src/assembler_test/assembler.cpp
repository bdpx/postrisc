...
DEFINE_TEST_HANDLER(r3_swapped)
{
    // mnem ra, rc, rb
    static const struct {
      unsigned ra, rb, rc;
...
DEFINE_TEST_HANDLER(bin_simm_plus)
{
    // addi ra, rb, simm21
    static const struct {
      unsigned ra, rb;
...
DEFINE_TEST_HANDLER(bin_uimm_plus)
{
    // addi ra, rb, uimm21
    static const struct {
      unsigned ra, rb;
...
DEFINE_TEST_HANDLER(bin_simm_minus)
{
    // addi ra, rb, simm21
    static const struct {
      unsigned ra, rb;
...
DEFINE_TEST_HANDLER(bin_uimm_minus)
{
    // addi ra, rb, uimm21
    static const struct {
      unsigned ra, rb;
...
DEFINE_TEST_HANDLER(br_rr_swapped)
{
    // mnem ra, rb, label17
    static const struct {
      unsigned ra, rb;
...
DEFINE_TEST_HANDLER(br_simm_plus)
{
    // mnem ra, simm11, label17
    static const struct {
      unsigned ra;
...
DEFINE_TEST_HANDLER(br_uimm_plus)
{
    // mnem ra, uimm11, label17
    static const struct {
      unsigned ra;
