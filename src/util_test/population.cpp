...
void common_test()
{
    ...
    const unsigned numbits = 8 * sizeof(T);
...
{
    common_test<uint32_t>();

    BOOST_TEST(util::population::func(UINT32_C(0x33333333)) == 16);
    BOOST_TEST(util::population::func(UINT32_C(0x55555555)) == 16);
}

BOOST_AUTO_TEST_CASE(test_64)
{
    common_test<uint64_t>();

    BOOST_TEST(util::population::func(UINT64_C(0x3333333333333333)) == 32);
    BOOST_TEST(util::population::func(UINT64_C(0x5555555555555555)) == 32);
}
