...
void
CAssembler::EvaluateSigned(CProgramSection& section)
{
...
CAssembler::GetLabel(i64 ip, ESectionKind requiredSectionType)
{
    ...
    const CAssemblerIdentifier& idInfo = GetIdentifierInfo(ident);
...
#define FIELD_HANDLER_ADDRESS(field, size, disp, fieldtype, inst_name, descr) \
    CFieldHandlerFunction(&CAssembler::FieldHandler_##field),
