...
inline bool iszero(quad_type f) { return f == 0.0; }
                ...
                switch (tokendata) {
                    #define FUNC_CASE_X(name) \
                         case func_table_##name: \
                             values.back() = F128_FUNC_NAME(name)(values.back()); \
                             break;
            ...
            case token_operator: {
                ...
                switch (tokendata) {
                    ...
                    case operator_percent:
                        ...
                        values.back() = F128_FUNC_NAME(remainder)(quad_type(va), quad_type(vb));
                        break;
                    ...
                    case operator_bitxor:
                        values.back() = F128_FUNC_NAME(pow)(quad_type(va), quad_type(vb));
                        break;
