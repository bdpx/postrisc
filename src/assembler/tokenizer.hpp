...
public:
    ...
    constexpr CParserToken(ETokenKind type, size_t data) : value(static_cast<u32>(data) | (static_cast<u32>(type) << data_bits)) {}
    constexpr CParserToken(EOperatorKind op) : value(op | (static_cast<u32>(token_operator) << data_bits)) {}
