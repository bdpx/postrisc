...
enum ERelocationType {
    ...
    reloc_branch,            // br,bpr,ldar(text) (27 bit, 16-byte align check)
    reloc_branch_long,       // br,bpr,ldar(text) (long)
    ...
    reloc_binimmu,           // binimm,minmax (16 bit, check)
    reloc_binimmu_long,      // binimm,minmax (57 bit, check)
    reloc_sbinimm,           // ldan (16 bit unsigned, check)
    reloc_sbinimm_long,      // ldan (57 bit unsigned, check)
    ...
    reloc_brc_uimm,          // compare-and-branch (unsigned 7 bit)
    reloc_brc_uimm_long,     // compare-and-branch (unsigned 32 bit)
