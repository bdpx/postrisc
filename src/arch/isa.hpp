...
#define DECLARE_INSTRUCTION_FIELDS(X) \
  ...
  X (indexed_scale_mode,       bits_per_indexed_scale_mode,       disp_indexed_scale_mode,  mod,    "sm",         "scale mode (64/32 bit, sign/zero index)") \
  ...
  X (ldar,                     bits_per_call,                     disp_call,                imm,    "simm28x16",  "long label text+rodata") \
  ...
  X (memory_order,             bits_per_memory_order,             disp_memory_order,        mod,    "mo",         "memory order") \
...
#define DECLARE_ASM_FORMATS(X) \
  ...
  X (ldar,       VARRAY(cf_lprefix, cf_argsdelimiter, cf_gpra, cf_comma, cf_ldar)) \
  ...
  X (gmemx,      VARRAY(cf_indexed_scale_mode, cf_lprefix, cf_argsdelimiter, cf_gpra, cf_comma, cf_gprb, cf_comma, cf_gprc, cf_comma, cf_indexed_scale, cf_comma, cf_indexed_disp)) \
  ...
  X (Rabcd,      VARRAY(cf_argsdelimiter, cf_gpra, cf_comma, cf_gprb, cf_comma, cf_gprc, cf_comma, cf_gprd)) \
  ...
  X (Rabc,       VARRAY(cf_argsdelimiter, cf_gpra, cf_comma, cf_gprb, cf_comma, cf_gprc)) \
  X (Racb,       VARRAY(cf_argsdelimiter, cf_gpra, cf_comma, cf_gprc, cf_comma, cf_gprb)) /* pseudo for Rabc */ \
  X (RabSc,      VARRAY(cf_argsdelimiter, cf_gpra, cf_comma, cf_gprb, cf_comma, cf_shamt_c)) \
  X (Rab,        VARRAY(cf_argsdelimiter, cf_gpra, cf_comma, cf_gprb)) \
  X (RabcMo,     VARRAY(cf_memory_order, cf_argsdelimiter, cf_gpra, cf_comma, cf_gprb, cf_comma, cf_gprc)) \
  X (RabMo,      VARRAY(cf_memory_order, cf_argsdelimiter, cf_gpra, cf_comma, cf_gprb)) \
  X (RbcMo,      VARRAY(cf_memory_order, cf_argsdelimiter, cf_gprb, cf_comma, cf_gprc)) \
  X (fence,      VARRAY(cf_memory_order)) \
  ...
  X (allocsp,    VARRAY(cf_argsdelimiter, cf_framesize, cf_comma, cf_bin_uimm)) \
  ...
  X (sprsr,      VARRAY(cf_argsdelimiter, cf_gpra, cf_comma, cf_spr, cf_comma, cf_gprc, cf_comma, cf_gprd)) \
...
#define DECLARE_INSTRUCTION_FORMATS(X) \
  ...
  X (ldar,     ldar,   "oooooooaaaaaaapppppppppppppppppppppppppppp", VARRAY(cf_gpra, cf_call), "branch/load ip-relative address") \
  X (RaU28,    ldafr,  "oooooooaaaaaaaiiiiiiiiiiiiiiiiiiiiiiiiiiii", VARRAY(cf_gpra, cf_rip_label), "load/store ip-relative") \
  X (br,       ldar,   "oooooooxxxxxxxiiiiiiiiiiiiiiiiiiiiiiiiiiii", VARRAY(cf_raopx, cf_call), "jump/call ip-relative") \
  X (RaxU28,   ldafr,  "oooooooxxxxxxxiiiiiiiiiiiiiiiiiiiiiiiiiiii", VARRAY(cf_raopx, cf_rip_label), "br/write ip-relative") \
  X (allocsp,  imbin,  "oooooooxxxxxxxfffffffiiiiiiiiiiiiiiiiiiiii", VARRAY(cf_raopx, cf_framesize, cf_bin_uimm), "allocsp") \
  ...
  X (RaxbBBS,  brc,    "oooooooxxxxxxxbbbbbbb----ppppppppppppppppp", VARRAY(cf_raopx, cf_gprb, cf_branch_opx_res, cf_branch), "ehadj") \
  ...
  X (gmemx,    imbin,  "oooooooaaaaaaabbbbbbbcccccccsssmmiiiiiiiii", VARRAY(cf_gpra, cf_gprb, cf_gprc, cf_indexed_scale, cf_indexed_scale_mode, cf_indexed_disp), "scaled index load/store") \
  ...
  X (alloc,    none,   "ooooooo-------fffffff----------xxxxxxxxxxx", VARRAY(cf_unused_reg, cf_framesize, cf_unused_reg, cf_misc_opx_null, cf_misc_opx), "alloc") \
  X (mspr,     none,   "oooooooaaaaaaakkkkkkk----------xxxxxxxxxxx", VARRAY(cf_gpra, cf_spr, cf_unused_reg, cf_misc_opx_null, cf_misc_opx), "move from/to special-purpose register") \
  X (Rab,      none,   "oooooooaaaaaaabbbbbbb----------xxxxxxxxxxx", VARRAY(cf_gpra, cf_gprb, cf_unused_reg, cf_misc_opx_null, cf_misc_opx), "unary") \
  ...
  X (Rabc,     none,   "oooooooaaaaaaabbbbbbbccccccc---xxxxxxxxxxx", VARRAY(cf_gpra, cf_gprb, cf_gprc, cf_misc_opx_null, cf_misc_opx), "binary register-register") \
  X (RabcMo,   none,   "oooooooaaaaaaabbbbbbbcccccccmmmxxxxxxxxxxx", VARRAY(cf_gpra, cf_gprb, cf_gprc, cf_memory_order, cf_misc_opx), "Atomic RMW") \
  X (RabMo,    none,   "oooooooaaaaaaabbbbbbb-------mmmxxxxxxxxxxx", VARRAY(cf_gpra, cf_gprb, cf_unused_reg, cf_memory_order, cf_misc_opx), "Atomic Load/Store") \
  X (RbcMo,    none,   "ooooooo-------bbbbbbbcccccccmmmxxxxxxxxxxx", VARRAY(cf_unused_reg, cf_gprb, cf_gprc, cf_memory_order, cf_misc_opx), "Atomic store-op") \
  X (fence,    none,   "ooooooo---------------------mmmxxxxxxxxxxx", VARRAY(cf_unused_reg, cf_unused_reg, cf_unused_reg, cf_memory_order, cf_misc_opx), "Atomic fence") \
...
#define DECLARE_INSTRUCTION_EXTENSION_FORMATS(X) \
  X (none,   "------------------------------------------",  "no extension") \
  X (ldar,   "----------pppppppppppppppppppppppppppppppp",  "60(28+32) bit jump offset") \
  X (ldi,    "------iiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiii",  "64(28+36) bit ldi imm") \
  X (ldafr,  "------pppppppppppppppppppppppppppppppppppp",  "64(28+36) bit load-relative offset") \
