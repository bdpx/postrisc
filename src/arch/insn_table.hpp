...
#define INSN_TABLE_ATOMIC_LD(X, NAME, TYPE, TYPE_NAME) \
    X(NAME ## TYPE     , atomic, r2, "load atomic " TYPE_NAME " relaxed") \
    X(NAME ## TYPE ## a, atomic, r2, "load atomic " TYPE_NAME " acquire")

#define INSN_TABLE_ATOMIC_ST(X, NAME, TYPE, TYPE_NAME) \
    X(NAME ## TYPE     , atomic, r2, "store atomic " TYPE_NAME " relaxed") \
    X(NAME ## TYPE ## r, atomic, r2, "store atomic " TYPE_NAME " release")

#define INSN_TABLE_ATOMIC_LD_OP(X, NAME, TYPE, TYPE_NAME, DESCR) \
    X(NAME ## TYPE      , atomic, r3, "atomic " DESCR " " TYPE_NAME " relaxed") \
    X(NAME ## TYPE ##  a, atomic, r3, "atomic " DESCR " " TYPE_NAME " acquire") \
    X(NAME ## TYPE ##  r, atomic, r3, "atomic " DESCR " " TYPE_NAME " release") \
    X(NAME ## TYPE ## ar, atomic, r3, "atomic " DESCR " " TYPE_NAME " acq_rel")

#define INSN_TABLE_ATOMIC_ST_OP(X, NAME, TYPE, TYPE_NAME, DESCR) \
    X(NAME ## TYPE     , atomic, Rbc, "atomic " DESCR " " TYPE_NAME " relaxed") \
    X(NAME ## TYPE ## r, atomic, Rbc, "atomic " DESCR " " TYPE_NAME " release")
...
#define INSN_TABLE_ATOMIC_FULL_X(X, TYPE, TYPE_NAME) \
    ...
    INSN_TABLE_ATOMIC_LD_OP(X, swap,   TYPE, TYPE_NAME, "swap") \
    INSN_TABLE_ATOMIC_LD_OP(X, cas,    TYPE, TYPE_NAME, "compare and swap") \
    INSN_TABLE_ATOMIC_LD_OP(X, ldadd,  TYPE, TYPE_NAME, "load add") \
    INSN_TABLE_ATOMIC_LD_OP(X, ldand,  TYPE, TYPE_NAME, "load bitwise and") \
    INSN_TABLE_ATOMIC_LD_OP(X, ldor,   TYPE, TYPE_NAME, "load bitwise or") \
    INSN_TABLE_ATOMIC_LD_OP(X, ldxor,  TYPE, TYPE_NAME, "load bitwise xor") \
    INSN_TABLE_ATOMIC_LD_OP(X, ldsmin, TYPE, TYPE_NAME, "load signed minimum") \
    INSN_TABLE_ATOMIC_LD_OP(X, ldsmax, TYPE, TYPE_NAME, "load signed maximum") \
    INSN_TABLE_ATOMIC_LD_OP(X, ldumin, TYPE, TYPE_NAME, "load unsigned minimum") \
    INSN_TABLE_ATOMIC_LD_OP(X, ldumax, TYPE, TYPE_NAME, "load unsigned maximum") \
    INSN_TABLE_ATOMIC_ST_OP(X, stadd,  TYPE, TYPE_NAME, "store add") \
    INSN_TABLE_ATOMIC_ST_OP(X, stand,  TYPE, TYPE_NAME, "store bitwise and") \
    INSN_TABLE_ATOMIC_ST_OP(X, stor,   TYPE, TYPE_NAME, "store bitwise or") \
    INSN_TABLE_ATOMIC_ST_OP(X, stxor,  TYPE, TYPE_NAME, "store bitwise xor") \
    INSN_TABLE_ATOMIC_ST_OP(X, stsmin, TYPE, TYPE_NAME, "store signed minimum") \
    INSN_TABLE_ATOMIC_ST_OP(X, stsmax, TYPE, TYPE_NAME, "store signed maximum") \
    INSN_TABLE_ATOMIC_ST_OP(X, stumin, TYPE, TYPE_NAME, "store unsigned minimum") \
    INSN_TABLE_ATOMIC_ST_OP(X, stumax, TYPE, TYPE_NAME, "store unsigned maximum") \
...
X(fencea,  atomic, NoArgs, "fencea")
X(fencer,  atomic, NoArgs, "fencer")
X(fencear, atomic, NoArgs, "fencear")
X(fencesc, atomic, NoArgs, "fencesc")
