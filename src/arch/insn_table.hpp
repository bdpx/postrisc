...
X("mul.q",    mul_q,   intq,  r3,  "multilpy quadword")
...
// divide/modulo
//===------------------------------------------------------===//
X("div.d",    div_d,   base, r3, "divide")
X("div.w",    div_w,   base, r3, "divide word")
X("divi.d",   divi_d,  base, RabSI21, "divide immediate")
X("divi.w",   divi_w,  base, RabSI21, "divide word immediate")
X("divu.d",   divu_d,  base, r3, "divide unsigned")
X("divu.w",   divu_w,  base, r3, "divide unsigned word")
X("divui.d",  divui_d, base, RabUI21, "divide unsigned immediate")
X("divui.w",  divui_w, base, RabUI21, "divide unsigned word immediate")
X("mod.d",    mod_d,   base, r3, "module")
X("mod.w",    mod_w,   base, r3, "module word")
X("modi.d",   modi_d,  base, RabSI21, "module immediate")
X("modi.w",   modi_w,  base, RabSI21, "module word immediate")
X("modu.d",   modu_d,  base, r3, "module unsigned")
X("modu.w",   modu_w,  base, r3, "module unsigned word")
X("modui.d",  modui_d, base, RabUI21, "module unsigned immediate")
X("modui.w",  modui_w, base, RabUI21, "module unsigned word immediate")
...
X("mins.d", mins_d,    base, r3, "minimum signed")
X("maxs.d", maxs_d,    base, r3, "maximum signed")
X("minu.d", minu_d,    base, r3, "minimum unsigned")
X("maxu.d", maxu_d,    base, r3, "maximum unsigned")

X("minsi.d", minsi_d,   base, RabSI21, "minimum signed immediate")
X("maxsi.d", maxsi_d,   base, RabSI21, "maximum signed immediate")
X("minui.d", minui_d,   base, RabUI21, "minimum unsigned immediate")
X("maxui.d", maxui_d,   base, RabUI21, "maximum unsigned immediate")
