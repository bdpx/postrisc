...
#define DECLARE_PRIMARY_OPCODES(X) \
    ...
    X(cmp_gt_imm_i128, 68) \
    X(cmp_gt_imm_u128, 69) /* reserved: 70, 71 */ \
    X(ld_u8,           72) \
    X(ld_i8,           73) \
    X(st_i8,           74) \
    X(ld_u16,          75) \
...
enum EInstructionOpcode {
    ...
    opcode_last,
    PSEUDO_INSN(br_le_imm_i64,   br_lt_imm_i64)
    PSEUDO_INSN(br_le_imm_u64,   br_lt_imm_u64)
    PSEUDO_INSN(br_gt_imm_i64,   br_ge_imm_i64)
    PSEUDO_INSN(br_gt_imm_u64,   br_ge_imm_u64)
    PSEUDO_INSN(br_le_imm_i32,   br_lt_imm_i32)
    PSEUDO_INSN(br_le_imm_u32,   br_lt_imm_u32)
    PSEUDO_INSN(br_gt_imm_i32,   br_ge_imm_i32)
    PSEUDO_INSN(br_gt_imm_u32,   br_ge_imm_u32)
    PSEUDO_INSN(br_le_imm_i128,  br_lt_imm_i128)
    PSEUDO_INSN(br_le_imm_u128,  br_lt_imm_u128)
    PSEUDO_INSN(br_gt_imm_i128,  br_ge_imm_i128)
    PSEUDO_INSN(br_gt_imm_u128,  br_ge_imm_u128)
    PSEUDO_INSN(cmp_ge_imm_i64,  cmp_gt_imm_i64)
    PSEUDO_INSN(cmp_ge_imm_u64,  cmp_gt_imm_u64)
    PSEUDO_INSN(cmp_le_imm_i64,  cmp_lt_imm_i64)
    PSEUDO_INSN(cmp_le_imm_u64,  cmp_lt_imm_u64)
    PSEUDO_INSN(cmp_ge_imm_i32,  cmp_gt_imm_i32)
    PSEUDO_INSN(cmp_ge_imm_u32,  cmp_gt_imm_u32)
    PSEUDO_INSN(cmp_le_imm_i32,  cmp_lt_imm_i32)
    PSEUDO_INSN(cmp_le_imm_u32,  cmp_lt_imm_u32)
    PSEUDO_INSN(cmp_ge_imm_i128, cmp_gt_imm_i128)
    PSEUDO_INSN(cmp_ge_imm_u128, cmp_gt_imm_u128)
    PSEUDO_INSN(cmp_le_imm_i128, cmp_lt_imm_i128)
    PSEUDO_INSN(cmp_le_imm_u128, cmp_lt_imm_u128)
...
#define DECLARE_FUSED_EXTENDED_OPCODES(X) \
    ...
    X(nmsub_vf64,      73) \
    X(madd_alt_vf64,   74) \
    X(msub_alt_vf64,   75) /* reserved: 76 */ \
    X(cmov_eq_i64,     77) \
    X(cmov_lt_i64,     78) \
    X(cmov_le_i64,     79) \
    X(merge_f32,       80) \
    ...
    X(nmsub_vf32,      89) \
    X(madd_alt_vf32,   90) \
    X(msub_alt_vf32,   91) /* reserved: 92 */ \
    X(merge_f16,       92) \
    X(madd_f16,        93) \
    X(msub_f16,        94) \
    X(nmadd_f16,       95) \
...
/**************************************************************************************
* opcode_nul_rr extended opcodes (4 bit)
**************************************************************************************/
#define DECLARE_NUL_RR_EXTENDED_OPCODES(X) \
    X(nul_eq_i64, 0) \
    X(nul_ne_i64, 1) \
    X(nul_lt_i64, 2) \
    X(nul_le_i64, 3) \
...
enum nul_rr_opx {
    DECLARE_NUL_RR_EXTENDED_OPCODES(OPCODE_X)
    nul_rr_opx_last
};

inline constexpr u64 insn_tmplt(const nul_rr_opx opx)
{
    return insn_tmplt(EFusedOpx::opcode_nul_rr)
         | makepart(static_cast<u64>(opx), disp_branch_opx);
}

/**************************************************************************************
* opcode_nul_i128 extended opcodes (4 bit)
**************************************************************************************/
#define DECLARE_NUL_I128_EXTENDED_OPCODES(X) \
    X(nul_eq_i128, 0) \
    X(nul_ne_i128, 1) \
    X(nul_lt_i128, 2) \
    X(nul_le_i128, 3) \
...
enum nul_i128_opx {
    DECLARE_NUL_I128_EXTENDED_OPCODES(OPCODE_X)
    nul_i128_opx_last
};

inline constexpr u64 insn_tmplt(const nul_i128_opx opx)
{
    return insn_tmplt(EFusedOpx::opcode_nul_i128)
         | makepart(static_cast<u64>(opx), disp_branch_opx);
}

/**************************************************************************************
* opcode_nul_f32 extended opcodes (4 bit)
**************************************************************************************/
#define DECLARE_NUL_F32_EXTENDED_OPCODES(X) \
    X(nul_oeq_f32,   0) \
    X(nul_one_f32,   1) \
    X(nul_olt_f32,   2) \
    X(nul_ole_f32,   3) \
...
enum nul_f32_opx {
    DECLARE_NUL_F32_EXTENDED_OPCODES(OPCODE_X)
    nul_f32_opx_last,
};

inline constexpr u64 insn_tmplt(const nul_f32_opx opx)
{
    return insn_tmplt(EFusedOpx::opcode_nul_f32)
         | makepart(static_cast<u64>(opx), disp_branch_opx);
}

/**************************************************************************************
* opcode_nul_f64 extended opcodes (4 bit)
**************************************************************************************/
#define DECLARE_NUL_F64_EXTENDED_OPCODES(X) \
    X(nul_oeq_f64,   0) \
    X(nul_one_f64,   1) \
    X(nul_olt_f64,   2) \
    X(nul_ole_f64,   3) \
...
enum nul_f64_opx {
    DECLARE_NUL_F64_EXTENDED_OPCODES(OPCODE_X)
    nul_f64_opx_last,
};

inline constexpr u64 insn_tmplt(const nul_f64_opx opx)
{
    return insn_tmplt(EFusedOpx::opcode_nul_f64)
         | makepart(static_cast<u64>(opx), disp_branch_opx);
}

/**************************************************************************************
* opcode_nul_f128 extended opcodes (4 bit)
**************************************************************************************/
#define DECLARE_NUL_F128_EXTENDED_OPCODES(X) \
    X(nul_oeq_f128,   0) \
    X(nul_one_f128,   1) \
    X(nul_olt_f128,   2) \
    X(nul_ole_f128,   3) \
...
enum nul_f128_opx {
    DECLARE_NUL_F128_EXTENDED_OPCODES(OPCODE_X)
    nul_f128_opx_last,
};

inline constexpr u64 insn_tmplt(const nul_f128_opx opx)
{
    return insn_tmplt(EFusedOpx::opcode_nul_f128)
         | makepart(static_cast<u64>(opx), disp_branch_opx);
}
...
**************************************************************************************/
#define DECLARE_BRR_EXTENDED_OPCODES(X) \
    X(br_eq_i64,   0) \
    X(br_ne_i64,   1) \
    X(br_lt_i64,   2) \
    X(br_le_i64,   3) \
...
enum brr_opx {
    ...
    brr_opx_last,
    PSEUDO_INSN(br_gt_i64, br_lt_i64)
    PSEUDO_INSN(br_gt_u64, br_lt_u64)
    PSEUDO_INSN(br_ge_i64, br_le_i64)
    PSEUDO_INSN(br_ge_u64, br_le_u64)
    PSEUDO_INSN(br_gt_i32, br_lt_i32)
    PSEUDO_INSN(br_gt_u32, br_lt_u32)
    PSEUDO_INSN(br_ge_i32, br_le_i32)
    PSEUDO_INSN(br_ge_u32, br_le_u32)
};

inline constexpr u64 insn_tmplt(const brr_opx opx)
{
...
/**************************************************************************************
* opcode_br_i128 extended opcodes (4 bit)
**************************************************************************************/
#define DECLARE_BR_I128_EXTENDED_OPCODES(X) \
    X(br_eq_i128,   0) \
    X(br_ne_i128,   1) \
    X(br_lt_i128,   2) \
    X(br_le_i128,   3) \
...
enum br_i128_opx {
    DECLARE_BR_I128_EXTENDED_OPCODES(OPCODE_X)
    br_i128_opx_last,
    PSEUDO_INSN(br_gt_i128, br_lt_i128)
    PSEUDO_INSN(br_gt_u128, br_lt_u128)
    PSEUDO_INSN(br_ge_i128, br_le_i128)
    PSEUDO_INSN(br_ge_u128, br_le_u128)
};

inline constexpr u64 insn_tmplt(const br_i128_opx opx)
{
    return insn_tmplt(EInstructionOpcode::opcode_br_i128)
         | makepart(static_cast<u64>(opx), disp_branch_opx);
}

/**************************************************************************************
* opcode_br_f32 extended opcodes (4 bit)
**************************************************************************************/
#define DECLARE_BR_F32_EXTENDED_OPCODES(X) \
    X(br_oeq_f32,   0) \
    X(br_one_f32,   1) \
    X(br_olt_f32,   2) \
    X(br_ole_f32,   3) \
...
enum br_f32_opx {
    DECLARE_BR_F32_EXTENDED_OPCODES(OPCODE_X)
    br_f32_opx_last,
};

inline constexpr u64 insn_tmplt(const br_f32_opx opx)
{
    return insn_tmplt(EInstructionOpcode::opcode_br_f32)
         | makepart(static_cast<u64>(opx), disp_branch_opx);
}

/**************************************************************************************
* opcode_br_f64 extended opcodes (4 bit)
**************************************************************************************/
#define DECLARE_BR_F64_EXTENDED_OPCODES(X) \
    X(br_oeq_f64,   0) \
    X(br_one_f64,   1) \
    X(br_olt_f64,   2) \
    X(br_ole_f64,   3) \
...
enum br_f64_opx {
    DECLARE_BR_F64_EXTENDED_OPCODES(OPCODE_X)
    br_f64_opx_last,
};

inline constexpr u64 insn_tmplt(const br_f64_opx opx)
{
    return insn_tmplt(EInstructionOpcode::opcode_br_f64)
         | makepart(static_cast<u64>(opx), disp_branch_opx);
}

/**************************************************************************************
* opcode_br_f128 extended opcodes (4 bit)
**************************************************************************************/
#define DECLARE_BR_F128_EXTENDED_OPCODES(X) \
    X(br_oeq_f128,   0) \
    X(br_one_f128,   1) \
    X(br_olt_f128,   2) \
    X(br_ole_f128,   3) \
...
enum br_f128_opx {
    DECLARE_BR_F128_EXTENDED_OPCODES(OPCODE_X)
    br_f128_opx_last,
};

inline constexpr u64 insn_tmplt(const br_f128_opx opx)
{
    return insn_tmplt(EInstructionOpcode::opcode_br_f128)
         | makepart(static_cast<u64>(opx), disp_branch_opx);
}

#define DECLARE_MEM_XI64_EXTENDED_OPCODES(X) \
    X(ld_xi64_u8,   0) \
    X(ld_xi64_i8,   1) \
    X(st_xi64_i8,   2) \
    X(ld_xi64_u16,  3) \
...
#define DECLARE_MEM_XI32_EXTENDED_OPCODES(X) \
    X(ld_xi32_u8,   0) \
    X(ld_xi32_i8,   1) \
    X(st_xi32_i8,   2) \
    X(ld_xi32_u16,  3) \
...
#define DECLARE_MEM_XU32_EXTENDED_OPCODES(X) \
    X(ld_xu32_u8,   0) \
    X(ld_xu32_i8,   1) \
    X(st_xu32_i8,   2) \
    X(ld_xu32_u16,  3) \
...
#define OPCODE_TABLE_ATOMIC_FULL_OPS(X, ITYPE, UTYPE, N) \
    ...
    OPCODE_TABLE_ATOMIC_LD_OP(X, ITYPE, cas,    N + 8) \
...
enum EMiscOpx {
    ...
    misc_opx_last,
    PSEUDO_INSN(cmp_gt_i32,  cmp_lt_i32)
    PSEUDO_INSN(cmp_gt_u32,  cmp_lt_u32)
    PSEUDO_INSN(cmp_ge_i32,  cmp_le_i32)
    PSEUDO_INSN(cmp_ge_u32,  cmp_le_u32)
    PSEUDO_INSN(cmp_gt_i64,  cmp_lt_i64)
    PSEUDO_INSN(cmp_gt_u64,  cmp_lt_u64)
    PSEUDO_INSN(cmp_ge_i64,  cmp_le_i64)
    PSEUDO_INSN(cmp_ge_u64,  cmp_le_u64)
    PSEUDO_INSN(cmp_gt_i128, cmp_lt_i128)
    PSEUDO_INSN(cmp_gt_u128, cmp_lt_u128)
    PSEUDO_INSN(cmp_ge_i128, cmp_le_i128)
    PSEUDO_INSN(cmp_ge_u128, cmp_le_u128)
};
