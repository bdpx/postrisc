...
#define OPCODE_TABLE_ATOMIC_FULL_OPS(X, TYPE, N) \
    ...
    OPCODE_TABLE_ATOMIC_LD_OP(X, TYPE, ldadd , N + 12) \
    OPCODE_TABLE_ATOMIC_LD_OP(X, TYPE, ldand,  N + 16) \
    OPCODE_TABLE_ATOMIC_LD_OP(X, TYPE, ldor,   N + 20) \
    OPCODE_TABLE_ATOMIC_LD_OP(X, TYPE, ldxor,  N + 24) \
    OPCODE_TABLE_ATOMIC_LD_OP(X, TYPE, ldsmin, N + 28) \
    OPCODE_TABLE_ATOMIC_LD_OP(X, TYPE, ldsmax, N + 32) \
    OPCODE_TABLE_ATOMIC_LD_OP(X, TYPE, ldumin, N + 36) \
    OPCODE_TABLE_ATOMIC_LD_OP(X, TYPE, ldumax, N + 40) \
    OPCODE_TABLE_ATOMIC_ST_OP(X, TYPE, stadd,  N + 44) \
    OPCODE_TABLE_ATOMIC_ST_OP(X, TYPE, stand,  N + 46) \
    OPCODE_TABLE_ATOMIC_ST_OP(X, TYPE, stor,   N + 48) \
    OPCODE_TABLE_ATOMIC_ST_OP(X, TYPE, stxor,  N + 50) \
    OPCODE_TABLE_ATOMIC_ST_OP(X, TYPE, stsmin, N + 52) \
    OPCODE_TABLE_ATOMIC_ST_OP(X, TYPE, stsmax, N + 54) \
    OPCODE_TABLE_ATOMIC_ST_OP(X, TYPE, stumin, N + 56) \
    OPCODE_TABLE_ATOMIC_ST_OP(X, TYPE, stumax, N + 58) \
...
#define DECLARE_MISC_EXTENDED_OPCODES(X) \
    ...
    X(fencea,          SPECIAL_BASE + 52) \
    X(fencer,          SPECIAL_BASE + 53) \
    X(fencear,         SPECIAL_BASE + 54) \
    X(fencesc,         SPECIAL_BASE + 55) \
