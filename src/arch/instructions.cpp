...
char const *GetScaleModeName(EScaleMode sm)
{
    switch (sm) {
        case scale_mode_dword:     return "xd";
        case scale_mode_sext_word: return "xw";
        case scale_mode_zext_word: return "xuw";
        case scale_mode_signed:    return "unknown";
    }
    return "unknown";
}

char const *GetMemoryOrderName(EMemoryOrder mo)
{
    switch (mo) {
        case EMemoryOrder::relaxed: return "relaxed";
        case EMemoryOrder::acquire: return "acquire";
        case EMemoryOrder::release: return "release";
        case EMemoryOrder::acq_rel: return "acq_rel";
        case EMemoryOrder::seq_cst: return "seq_cst";
    }
    return "unknown-mo";
}
