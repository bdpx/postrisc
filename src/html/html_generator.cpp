...
int Decoder::GenerateHtml(std::ostream& out)
{
    ...
    for (size_t i = 0; i < chap_last; i++) {
        out << "<li><a href=\"#chapter_" << i << "\">" << ChapterTitle(static_cast<Chapter>(i)) << "</a></li>\n";
    }
    out << "</ul>\n";
    ...
    ****************************************************************************/
    ...
    for (const auto & insn : asm_names) {
        ...
        out << "<tr><td>" << instr_subset_name[subset] << "</td>"
               "<td><a href=\"#" << to_attribute(insn_name(inst)) << "\">" << insn_name(inst) << "</a>";
    ...
    ****************************************************************************/
    ...
    const size_t opx_size = 32; // 1(opcodes) + 20(all extcodes)
