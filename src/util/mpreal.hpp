...
// FIX: C++ doesn't know about _Float128
...
public:
    ...
    mpreal(const _Float128 u,              mp_prec_t prec = mpreal::get_default_prec(), mp_rnd_t mode = mpreal::get_default_rnd());
#endif
...
#ifdef MPFR_WANT_FLOAT128
    mpreal& operator=(const _Float128 v);
#endif
    ...
    mpreal& operator+=(const mpq_t v);
#ifdef MPFR_WANT_FLOAT128
    mpreal& operator+=(const _Float128 u);
#endif
...
#ifdef MPFR_WANT_FLOAT128
    _Float128          toFloat128  (mp_rnd_t mode = GMP_RNDN)    const;
#endif
...
#ifdef MPFR_WANT_FLOAT128
    explicit operator _Float128          () const { return toFloat128();             }
#endif
#endif
...
#ifdef MPFR_WANT_FLOAT128
inline mpreal::mpreal(const _Float128 u, mp_prec_t prec, mp_rnd_t mode)
{
    mpfr_init2 (mpfr_ptr(), prec);
    mpfr_set_float128(mpfr_ptr(), u, mode);
...
#ifdef MPFR_WANT_FLOAT128
    template <> struct result_type<_Float128>           {typedef mpreal type;};
#endif
...
#ifdef MPFR_WANT_FLOAT128
const mpreal sqrt(const _Float128 v, mp_rnd_t rnd_mode = mpreal::get_default_rnd());
#endif
...
#ifdef MPFR_WANT_FLOAT128
const mpreal pow(const mpreal& a, const _Float128 b, mp_rnd_t rnd_mode = mpreal::get_default_rnd());
#endif
...
#ifdef MPFR_WANT_FLOAT128
const mpreal pow(const _Float128 a, const mpreal& b, mp_rnd_t rnd_mode = mpreal::get_default_rnd());
#endif
...
#ifdef MPFR_WANT_FLOAT128
const mpreal pow(const unsigned long int a, const _Float128 b, mp_rnd_t rnd_mode = mpreal::get_default_rnd());
#endif
...
#ifdef MPFR_WANT_FLOAT128
const mpreal pow(const unsigned int a, const _Float128 b, mp_rnd_t rnd_mode = mpreal::get_default_rnd());
#endif
...
#ifdef MPFR_WANT_FLOAT128
const mpreal pow(const long int a, const _Float128 b, mp_rnd_t rnd_mode = mpreal::get_default_rnd());
#endif
...
#ifdef MPFR_WANT_FLOAT128
const mpreal pow(const int a, const _Float128 b, mp_rnd_t rnd_mode = mpreal::get_default_rnd());
#endif
...
#ifdef MPFR_WANT_FLOAT128
const mpreal pow(const long double a, const _Float128 b, mp_rnd_t rnd_mode = mpreal::get_default_rnd());
#endif
...
#ifdef MPFR_WANT_FLOAT128
inline mpreal& mpreal::operator=(const _Float128 v)
{
    mpfr_set_float128(mpfr_ptr(), v, mpreal::get_default_rnd());
...
#ifdef MPFR_WANT_FLOAT128
inline mpreal& mpreal::operator+= (const _Float128 u)
{
    *this += mpreal(u);
    MPREAL_MSVC_DEBUGVIEW_CODE;
    return *this;
...
#ifdef MPFR_WANT_FLOAT128
inline _Float128          mpreal::toFloat128(mp_rnd_t mode)  const    {    return  mpfr_get_float128(mpfr_srcptr(), mode);    }
#endif
...
inline std::string mpreal::toString(int n, int b, mp_rnd_t mode) const
{
    ...
    mp_exp_t exp;
    char *s  = mpfr_get_str(NULL, &exp, b, 0, mp, mode);
    char *ns = mpfr_get_str(NULL, &exp, b, (std::max)(0,n), mp, mode);
...
#ifdef MPFR_WANT_FLOAT128
inline const mpreal sqrt  (const _Float128 v, mp_rnd_t rnd_mode)    {   return sqrt(mpreal(v),rnd_mode);    }
#endif
...
#ifdef MPFR_WANT_FLOAT128
inline const mpreal pow(const mpreal& a, const _Float128 b, mp_rnd_t rnd_mode)
{
    return pow(a,mpreal(b),rnd_mode);
}
#endif
...
#ifdef MPFR_WANT_FLOAT128
inline const mpreal pow(const _Float128 a, const mpreal& b, mp_rnd_t rnd_mode)
{
...
#ifdef MPFR_WANT_FLOAT128
inline const mpreal pow(const unsigned long int a, const _Float128 b, mp_rnd_t rnd_mode)
{
...
#ifdef MPFR_WANT_FLOAT128
inline const mpreal pow(const unsigned int a, const _Float128 b, mp_rnd_t rnd_mode)
{
...
#ifdef MPFR_WANT_FLOAT128
inline const mpreal pow(const long int a, const _Float128 b, mp_rnd_t rnd_mode)
{
...
#ifdef MPFR_WANT_FLOAT128
inline const mpreal pow(const int a, const _Float128 b, mp_rnd_t rnd_mode)
{
    if (a>=0)   return pow(static_cast<unsigned long int>(a),mpreal(b),rnd_mode); //mpfr_ui_pow
    else        return pow(mpreal(a),mpreal(b),rnd_mode); //mpfr_pow
}
...
#ifdef MPFR_WANT_FLOAT128
inline const mpreal pow(const _Float128 a, const _Float128 b, mp_rnd_t rnd_mode)
{
    return pow(mpreal(a),mpreal(b),rnd_mode);
}

inline const mpreal pow(const _Float128 a, const long double b, mp_rnd_t rnd_mode)
{
    return pow(mpreal(a),mpreal(b),rnd_mode);
}

inline const mpreal pow(const _Float128 a, const unsigned long int b, mp_rnd_t rnd_mode)
{
    return pow(mpreal(a),b,rnd_mode); //mpfr_pow_ui
}

inline const mpreal pow(const _Float128 a, const unsigned int b, mp_rnd_t rnd_mode)
{
    return pow(mpreal(a),static_cast<unsigned long int>(b),rnd_mode); //mpfr_pow_ui
}

inline const mpreal pow(const _Float128 a, const long int b, mp_rnd_t rnd_mode)
{
    return pow(mpreal(a),b,rnd_mode); // mpfr_pow_si
}

inline const mpreal pow(const _Float128 a, const int b, mp_rnd_t rnd_mode)
{
    return pow(mpreal(a),static_cast<long int>(b),rnd_mode); // mpfr_pow_si
}
#endif
...
// pow long double
#ifdef MPFR_WANT_FLOAT128
inline const mpreal pow(const long double a, const _Float128 b, mp_rnd_t rnd_mode)
{
    return pow(mpreal(a),mpreal(b),rnd_mode);
}
#endif
