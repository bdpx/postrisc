...
static u32
singletable_crc32c(u32 crc, const void *buf, size_t size)
{
    const u8 *p = buf;
    while (size--)
...
static const u32 sctp_crc_tableil8_o32[256] =
{
...
static const u32 sctp_crc_tableil8_o40[256] =
{
...
static const u32 sctp_crc_tableil8_o48[256] =
{
...
static const u32 sctp_crc_tableil8_o56[256] =
{
...
static const u32 sctp_crc_tableil8_o64[256] =
{
...
static const u32 sctp_crc_tableil8_o72[256] =
{
...
static const u32 sctp_crc_tableil8_o80[256] =
{
...
static const u32 sctp_crc_tableil8_o88[256] =
{
...
#else
        term1 = sctp_crc_tableil8_o56[(*(const u32 *) p_buf) & 0x000000FF] ^
            sctp_crc_tableil8_o48[((*(const u32 *) p_buf) >> 8) & 0x000000FF];

        term2 = (*(const u32 *) p_buf) >> 16;
        crc = crc ^
            term1 ^
    ...
    unsigned int length)
{
    ...
    to_even_word = (4 - (std::bit_cast<uintptr_t>(buffer) & 0x3));
    return (crc32c_sb8_64_bit(crc32c, buffer, length, to_even_word));
}

u32
calculate_crc32c(u32 crc32c,
    const unsigned char *buffer,
    unsigned int length)
{
    if (length < 4) {
