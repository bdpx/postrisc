...
CODEGEN_HANDLER(BuiltinNoArgs)
{
    for (const auto& func : builtin_noargs_functions) {
        ...
        if (strcmp(func.name, "trap") == 0) {
            out << CHECK_NEXT << insn_name(insn_nop) << " 0\n";
        } else {
...
#undef SPECIAL_REGISTER_ENUM_X
    ...
    { "aeskeygenassist2",     insn_aes_keygen_assist,  "v2i64", "v2i64", " %r1, %r1, -1",      "__builtin_postrisc_aeskeygenassist(x, 255)" }, // FIXME: should be 255
    ...
    { "vec_sll_imm",   insn_sll_imm_vu8,       "v16u8", "v16u8", " %r1, %r1, 5",    "(x << 5)" },
    { "vec_sll_imm",   insn_sll_imm_vu16,      "v8u16", "v8u16", " %r1, %r1, 10",   "(x << 10)" },
    { "vec_sll_imm",   insn_sll_imm_vu32,      "v4u32", "v4u32", " %r1, %r1, 20",   "(x << 20)" },
    { "vec_sll_imm",   insn_sll_imm_vu64,      "v2u64", "v2u64", " %r1, %r1, 40",   "(x << 40)" },

    { "vec_srl_imm",   insn_srl_imm_vu8,       "v16u8", "v16u8", " %r1, %r1, 5",    "(x >> 5)" },
    { "vec_srl_imm",   insn_srl_imm_vu16,      "v8u16", "v8u16", " %r1, %r1, 10",   "(x >> 10)" },
    { "vec_srl_imm",   insn_srl_imm_vu32,      "v4u32", "v4u32", " %r1, %r1, 20",   "(x >> 20)" },
    { "vec_srl_imm",   insn_srl_imm_vu64,      "v2u64", "v2u64", " %r1, %r1, 40",   "(x >> 40)" },

    { "vec_sra_imm",   insn_sra_imm_vi8,       "v16i8", "v16i8", " %r1, %r1, 5",    "(x >> 5)" },
    { "vec_sra_imm",   insn_sra_imm_vi16,      "v8i16", "v8i16", " %r1, %r1, 10",   "(x >> 10)" },
    { "vec_sra_imm",   insn_sra_imm_vi32,      "v4i32", "v4i32", " %r1, %r1, 20",   "(x >> 20)" },
    { "vec_sra_imm",   insn_sra_imm_vi64,      "v2i64", "v2i64", " %r1, %r1, 40",   "(x >> 40)" },
...
static const binary_info builtin_binary_functions[] =
{
    ...
    { "set_itr",      insn_set_itr,  "void", "u64", "void*", "%r1, %r2, %r1",       "__builtin_postrisc_set_itr(a, b, a)" },
    { "set_dtr",      insn_set_dtr,  "void", "u64", "void*", "%r1, %r2, %r1",       "__builtin_postrisc_set_dtr(a, b, a)" },
    ...
    { "clmul_ll",        insn_clmul,     "v2i64", "v2i64", "v2i64", "%r1, %r1, %r2, 0",     "__builtin_postrisc_clmul_ll(a, b)" },
    { "clmul_hl",        insn_clmul,     "v2i64", "v2i64", "v2i64", "%r1, %r1, %r2, 1",     "__builtin_postrisc_clmul_hl(a, b)" },
    { "clmul_hh",        insn_clmul,     "v2i64", "v2i64", "v2i64", "%r1, %r1, %r2, 3",     "__builtin_postrisc_clmul_hh(a, b)" },

#define VECTOR_SIMD_BUILTINS(STYPE, UTYPE, SPREF, UPREF) \
    { "builtin_addc",        insn_addc_       ## UPREF, #UTYPE, #UTYPE, #UTYPE, "%r1, %r1, %r2", "__builtin_postrisc_addc_"       #UPREF "(a, b)" }, \
    { "builtin_addo",        insn_addo_       ## SPREF, #STYPE, #STYPE, #STYPE, "%r1, %r1, %r2", "__builtin_postrisc_addo_"       #SPREF "(a, b)" }, \
    { "builtin_subb",        insn_subb_       ## UPREF, #UTYPE, #UTYPE, #UTYPE, "%r1, %r1, %r2", "__builtin_postrisc_subb_"       #UPREF "(a, b)" }, \
    { "builtin_subo",        insn_subo_       ## SPREF, #STYPE, #STYPE, #STYPE, "%r1, %r1, %r2", "__builtin_postrisc_subo_"       #SPREF "(a, b)" }, \
    { "builtin_avg",         insn_avg_        ## UPREF, #UTYPE, #UTYPE, #UTYPE, "%r1, %r1, %r2", "__builtin_postrisc_avg_"        #UPREF "(a, b)" }, \
    { "builtin_avg",         insn_avg_        ## SPREF, #STYPE, #STYPE, #STYPE, "%r1, %r1, %r2", "__builtin_postrisc_avg_"        #SPREF "(a, b)" }, \
    { "builtin_sll",         insn_sll_        ## UPREF, #UTYPE, #UTYPE, #UTYPE, "%r1, %r1, %r2", "__builtin_postrisc_sll_"        #UPREF "(a, b)" }, \
    { "builtin_srl",         insn_srl_        ## UPREF, #UTYPE, #UTYPE, #UTYPE, "%r1, %r1, %r2", "__builtin_postrisc_srl_"        #UPREF "(a, b)" }, \
    { "builtin_sra",         insn_sra_        ## SPREF, #STYPE, #STYPE, #STYPE, "%r1, %r1, %r2", "__builtin_postrisc_sra_"        #SPREF "(a, b)" }, \
    { "builtin_rol",         insn_rol_        ## UPREF, #UTYPE, #UTYPE, #UTYPE, "%r1, %r1, %r2", "__builtin_postrisc_rol_"        #UPREF "(a, b)" }, \
    { "builtin_ror",         insn_ror_        ## UPREF, #UTYPE, #UTYPE, #UTYPE, "%r1, %r1, %r2", "__builtin_postrisc_ror_"        #UPREF "(a, b)" }, \
    { "builtin_cmp_eq",      insn_cmp_eq_     ## SPREF, #STYPE, #STYPE, #STYPE, "%r1, %r1, %r2", "__builtin_postrisc_cmp_eq_"     #SPREF "(a, b)" }, \
    { "builtin_cmp_lt",      insn_cmp_lt_     ## SPREF, #STYPE, #STYPE, #STYPE, "%r1, %r1, %r2", "__builtin_postrisc_cmp_lt_"     #SPREF "(a, b)" }, \
    { "builtin_cmp_lt",      insn_cmp_lt_     ## UPREF, #UTYPE, #UTYPE, #UTYPE, "%r1, %r1, %r2", "__builtin_postrisc_cmp_lt_"     #UPREF "(a, b)" }, \
    { "builtin_merge_high",  insn_merge_high_ ## UPREF, #UTYPE, #UTYPE, #UTYPE, "%r1, %r1, %r2", "__builtin_postrisc_merge_high_" #UPREF "(a, b)" }, \
    { "builtin_merge_low",   insn_merge_low_  ## UPREF, #UTYPE, #UTYPE, #UTYPE, "%r1, %r1, %r2", "__builtin_postrisc_merge_low_"  #UPREF "(a, b)" }, \
    { "vec_sll",             insn_sll_        ## UPREF, #UTYPE, #UTYPE, #UTYPE, "%r1, %r1, %r2", "(a << b)" }, \
    { "vec_srl",             insn_srl_        ## UPREF, #UTYPE, #UTYPE, #UTYPE, "%r1, %r1, %r2", "(a >> b)" }, \
    { "vec_sra",             insn_sra_        ## SPREF, #STYPE, #STYPE, #STYPE, "%r1, %r1, %r2", "(a >> b)" }, \
    { "vec_add",             insn_add_        ## UPREF, #UTYPE, #UTYPE, #UTYPE, "%r1, %r2, %r1", "(a + b)" }, \
    { "vec_sub",             insn_sub_        ## UPREF, #UTYPE, #UTYPE, #UTYPE, "%r1, %r1, %r2", "(a - b)" }, \
    { "vec_min",             insn_min_        ## SPREF, #STYPE, #STYPE, #STYPE, "%r1, %r1, %r2", "__builtin_elementwise_min(a, b)" }, \
    { "vec_max",             insn_max_        ## SPREF, #STYPE, #STYPE, #STYPE, "%r1, %r1, %r2", "__builtin_elementwise_max(a, b)" }, \
    { "vec_min",             insn_min_        ## UPREF, #UTYPE, #UTYPE, #UTYPE, "%r1, %r1, %r2", "__builtin_elementwise_min(a, b)" }, \
    { "vec_max",             insn_max_        ## UPREF, #UTYPE, #UTYPE, #UTYPE, "%r1, %r1, %r2", "__builtin_elementwise_max(a, b)" }, \
    { "vec_add_sat",         insn_add_sat_    ## SPREF, #STYPE, #STYPE, #STYPE, "%r1, %r1, %r2", "__builtin_elementwise_add_sat(a, b)" }, \
    { "vec_sub_sat",         insn_sub_sat_    ## SPREF, #STYPE, #STYPE, #STYPE, "%r1, %r1, %r2", "__builtin_elementwise_sub_sat(a, b)" }, \
    { "vec_add_sat",         insn_add_sat_    ## UPREF, #UTYPE, #UTYPE, #UTYPE, "%r1, %r1, %r2", "__builtin_elementwise_add_sat(a, b)" }, \
    { "vec_sub_sat",         insn_sub_sat_    ## UPREF, #UTYPE, #UTYPE, #UTYPE, "%r1, %r1, %r2", "__builtin_elementwise_sub_sat(a, b)" }, \

VECTOR_SIMD_BUILTINS(v16i8, v16u8, vi8,  vu8)
VECTOR_SIMD_BUILTINS(v8i16, v8u16, vi16, vu16)
VECTOR_SIMD_BUILTINS(v4i32, v4u32, vi32, vu32)
VECTOR_SIMD_BUILTINS(v2i64, v2u64, vi64, vu64)
