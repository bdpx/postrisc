...
public:
    ...
    template<typename FLOAT> FLOAT add(FLOAT a, FLOAT b, RoundingModeEnum) { return FLOAT::soft( a.hard() + b.hard() ); }
    template<typename FLOAT> FLOAT sub(FLOAT a, FLOAT b, RoundingModeEnum) { return FLOAT::soft( a.hard() - b.hard() ); }
    template<typename FLOAT> FLOAT mul(FLOAT a, FLOAT b, RoundingModeEnum) { return FLOAT::soft( a.hard() * b.hard() ); }
    template<typename FLOAT> FLOAT div(FLOAT a, FLOAT b, RoundingModeEnum) { return FLOAT::soft( a.hard() / b.hard() ); }
    ...
    template<typename FLOAT> FLOAT muladd(FLOAT a, FLOAT b, FLOAT c, RoundingModeEnum, muladd_negate_t);
    template<typename FLOAT> FLOAT sqrt(FLOAT a, RoundingModeEnum);
    template<typename FLOAT> FLOAT exp(FLOAT a, RoundingModeEnum);
    template<typename FLOAT> FLOAT log2(FLOAT a, RoundingModeEnum);
};
