...
template<> f128 HardFPU::sqrt<f128>(f128 a, RoundingModeEnum UNUSED(rm)) { return f128::soft( F128_FUNC_NAME(sqrt)( a.hard() ) ); }
...
template<> f128 HardFPU::log2<f128>(f128 a, RoundingModeEnum UNUSED(rm)) { return f128::soft( F128_FUNC_NAME(log2)( a.hard() ) ); }
...
template<> f128 HardFPU::round<f128>(f128 a, RoundingModeEnum UNUSED(rm), bool UNUSED(inexact)) { return f128::soft(F128_FUNC_NAME(rint)(a.hard())); }
...
template<> i128 HardFPU::cvt_f_i<i128, f32>(f32 a, RoundingModeEnum UNUSED(rm)) { return (native::f128)F128_FUNC_NAME(rint)(a.hard()); }
template<> u128 HardFPU::cvt_f_i<u128, f32>(f32 a, RoundingModeEnum UNUSED(rm)) { return (native::f128)F128_FUNC_NAME(rint)(a.hard()); }
template<> i128 HardFPU::cvt_f_i<i128, f64>(f64 a, RoundingModeEnum UNUSED(rm)) { return (native::f128)F128_FUNC_NAME(rint)(a.hard()); }
template<> u128 HardFPU::cvt_f_i<u128, f64>(f64 a, RoundingModeEnum UNUSED(rm)) { return (native::f128)F128_FUNC_NAME(rint)(a.hard()); }

template<> i32  HardFPU::cvt_f_i<i32,  f128>(f128 a, RoundingModeEnum UNUSED(rm)) { return (native::f128)F128_FUNC_NAME(rint)(a.hard()); }
template<> i64  HardFPU::cvt_f_i<i64,  f128>(f128 a, RoundingModeEnum UNUSED(rm)) { return (native::f128)F128_FUNC_NAME(rint)(a.hard()); }
template<> i128 HardFPU::cvt_f_i<i128, f128>(f128 a, RoundingModeEnum UNUSED(rm)) { return (native::f128)F128_FUNC_NAME(rint)(a.hard()); }

template<> u32  HardFPU::cvt_f_i<u32,  f128>(f128 a, RoundingModeEnum UNUSED(rm)) { return (native::f128)F128_FUNC_NAME(rint)(a.hard()); }
template<> u64  HardFPU::cvt_f_i<u64,  f128>(f128 a, RoundingModeEnum UNUSED(rm)) { return (native::f128)F128_FUNC_NAME(rint)(a.hard()); }
template<> u128 HardFPU::cvt_f_i<u128, f128>(f128 a, RoundingModeEnum UNUSED(rm)) { return (native::f128)F128_FUNC_NAME(rint)(a.hard()); }
