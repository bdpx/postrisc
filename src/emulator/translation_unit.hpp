...
public:
    ...
    TranslateAddress(IAddressSpace &as, CPerformanceMonitor &performance_monitor,
...
ALWAYS_INLINE
std::tuple<CStatus, CPhysAddress>
TranslationUnit::TranslateAddress(IAddressSpace &as, CPerformanceMonitor &performance_monitor,
    const CVirtAddress va, u64 requested_rights, u64 unexpected_rights)
{
