...
std::ostream&
operator << (std::ostream& out, const SoftExceptionState& r)
{
...
std::ostream&
operator << (std::ostream& out, const CInstructionBreakpointRegister& r)
{
    return out << fmt::hex(r.address) << '_' << fmt::hex(r.mask);
}

std::ostream&
operator << (std::ostream& out, const CDataBreakpointRegister& r)
{
    return out << fmt::hex(r.address) << '_' << fmt::hex(r.mask);
}
