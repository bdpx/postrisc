...
void
CPerformanceMonitor::dump_statistic(uint64_t itc, bool timing, const DumpFormatter& out) const
{
    out << "performance monitor:\n";

    uint64_t const insn_summary = mr[PMC_SHORT_INSTRUCTION] + mr[PMC_LONG_INSTRUCTION];
