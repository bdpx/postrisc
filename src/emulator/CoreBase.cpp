...
#define BASE_SCALAR(STYPE, UTYPE) \
    ...
    DEFINE_INSN_IMPLEMENTATION_NOMEM(srd_        ## STYPE) { return core.binary_reg_reg <STYPE, shift_right_div> (); } \
    ...
    DEFINE_INSN_IMPLEMENTATION_NOMEM(srd_imm_    ## STYPE) { return core.BinaryRegShamt<STYPE, shift_right_div_immediate> (); } \
