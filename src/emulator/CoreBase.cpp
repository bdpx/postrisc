...
DEFINE_INSN_IMPLEMENTATION_NOMEM(rlmi)
{
    ...
    const u64 mask = rol<u64>(util::makemask<u64>(num_ones), offset);
...
DEFINE_INSN_IMPLEMENTATION_NOMEM(div_d)  { return core.binary_reg_reg_divmod < i64, div > (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(divu_d) { return core.binary_reg_reg_divmod < u64, div > (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(mod_d)  { return core.binary_reg_reg_divmod < i64, mod > (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(modu_d) { return core.binary_reg_reg_divmod < u64, mod > (); }
...
DEFINE_INSN_IMPLEMENTATION_NOMEM(maxs_d) {     return core.binary_reg_reg < i64, max> (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(maxu_d) {     return core.binary_reg_reg < u64, max> (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(mins_d) {     return core.binary_reg_reg < i64, min> (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(minu_d) {     return core.binary_reg_reg < u64, min> (); }
...
DEFINE_INSN_IMPLEMENTATION_NOMEM(maxsi_d)  {  return core.BinaryRegSimm< i64, max         > (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(minsi_d)  {  return core.BinaryRegSimm< i64, min         > (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(maxui_d)  {  return core.BinaryRegSimm< u64, max         > (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(minui_d)  {  return core.BinaryRegSimm< u64, min         > (); }
...
DEFINE_INSN_IMPLEMENTATION_NOMEM(divi_d)  { return core.binary_reg_simm_divmod< i64, div > (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(modi_d)  { return core.binary_reg_simm_divmod< i64, mod > (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(divui_d) { return core.binary_reg_simm_divmod< u64, div > (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(modui_d) { return core.binary_reg_simm_divmod< u64, mod > (); }

DEFINE_INSN_IMPLEMENTATION_NOMEM(divi_w)  { return core.binary_reg_simm_divmod< i32, div > (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(modi_w)  { return core.binary_reg_simm_divmod< i32, mod > (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(divui_w) { return core.binary_reg_simm_divmod< u32, div > (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(modui_w) { return core.binary_reg_simm_divmod< u32, mod > (); }
