...
DEFINE_INSN_IMPLEMENTATION_NOMEM(dep_s)
{
    ...
    core.ra() = core.rb().scalar<u128>() | mask;
    return core.FinalizeInstruction();
}
...
// funnel shifts
DEFINE_INSN_IMPLEMENTATION_NOMEM(srp_i32)  {  return core.fused_reg_reg_reg <u32, shift_right_pair > (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(slp_i32)  {  return core.fused_reg_reg_reg <u32, shift_left_pair  > (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(srp_i64)  {  return core.fused_reg_reg_reg <u64, shift_right_pair > (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(slp_i64)  {  return core.fused_reg_reg_reg <u64, shift_left_pair  > (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(srp_i128) {  return core.fused_reg_reg_reg <u128,shift_right_pair > (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(slp_i128) {  return core.fused_reg_reg_reg <u128,shift_left_pair  > (); }
...
DEFINE_INSN_IMPLEMENTATION_NOMEM(neg_i32)  { return core.unary_reg <i32,  neg> (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(neg_i64)  { return core.unary_reg <i64,  neg> (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(neg_i128) { return core.unary_reg <i128, neg> (); }
...
// arithmetic
DEFINE_INSN_IMPLEMENTATION_NOMEM(add_i64)  { return core.binary_reg_reg < i64, add                > (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(add_i32)  { return core.binary_reg_reg < i32, add                > (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(add_u32)  { return core.binary_reg_reg < u32, add                > (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(add_i128) { return core.binary_reg_reg <i128, add                > (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(sub_i64)  { return core.binary_reg_reg < i64, subtract           > (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(sub_i32)  { return core.binary_reg_reg < i32, subtract           > (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(sub_u32)  { return core.binary_reg_reg < u32, subtract           > (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(sub_i128) { return core.binary_reg_reg <i128, subtract           > (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(mul_i64)  { return core.binary_reg_reg < i64, mul                > (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(mul_i32)  { return core.binary_reg_reg < i32, mul                > (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(mul_u32)  { return core.binary_reg_reg < u32, mul                > (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(mul_i128) { return core.binary_reg_reg <i128, mul                > (); }
...
DEFINE_INSN_IMPLEMENTATION_NOMEM(abs_diff_i64) { return core.binary_reg_reg < i64, absolute_difference> (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(abs_diff_i32) { return core.binary_reg_reg < i32, absolute_difference> (); }

DEFINE_INSN_IMPLEMENTATION_NOMEM(abs_i32)  { return core.unary_reg <i32, absolute_value> (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(abs_i64)  { return core.unary_reg <i64, absolute_value> (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(abs_i128) { return core.unary_reg <i128, absolute_value> (); }
...
DEFINE_INSN_IMPLEMENTATION_NOMEM(div_i64) { return core.binary_reg_reg_divmod < i64, div > (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(div_u64) { return core.binary_reg_reg_divmod < u64, div > (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(rem_i64) { return core.binary_reg_reg_divmod < i64, mod > (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(rem_u64) { return core.binary_reg_reg_divmod < u64, mod > (); }

DEFINE_INSN_IMPLEMENTATION_NOMEM(div_i32) { return core.binary_reg_reg_divmod < i32, div > (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(div_u32) { return core.binary_reg_reg_divmod < u32, div > (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(rem_i32) { return core.binary_reg_reg_divmod < i32, mod > (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(rem_u32) { return core.binary_reg_reg_divmod < u32, mod > (); }
...
DEFINE_INSN_IMPLEMENTATION_NOMEM(max_i64) {     return core.binary_reg_reg < i64, max> (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(max_u64) {     return core.binary_reg_reg < u64, max> (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(min_i64) {     return core.binary_reg_reg < i64, min> (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(min_u64) {     return core.binary_reg_reg < u64, min> (); }

DEFINE_INSN_IMPLEMENTATION_NOMEM(max_i32) {    return core.binary_reg_reg < i32, max> (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(max_u32) {    return core.binary_reg_reg < u32, max> (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(min_i32) {    return core.binary_reg_reg < i32, min> (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(min_u32) {    return core.binary_reg_reg < u32, min> (); }

// shifts
DEFINE_INSN_IMPLEMENTATION_NOMEM(sll_u64) { return core.binary_reg_reg < u64, shift_left > (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(srl_u64) { return core.binary_reg_reg < u64, shift_right> (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(sra_i64) { return core.binary_reg_reg < i64, shift_right> (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(srd_i64) { return core.binary_reg_reg < i64, shift_right_div> (); }

DEFINE_INSN_IMPLEMENTATION_NOMEM(sll_u32) { return core.binary_reg_reg < u32, shift_left > (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(srl_u32) { return core.binary_reg_reg < u32, shift_right> (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(sra_i32) { return core.binary_reg_reg < i32, shift_right> (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(srd_i32) { return core.binary_reg_reg < i32, shift_right_div> (); }
...
Result Core::NullifyConditionally(bool condition)
{
    ...
    u64 const mask =
    condition ? (util::makemask<u64>(dist_yes)            )
              : (util::makemask<u64>(dist_not) << dist_yes);
...
DEFINE_INSN_IMPLEMENTATION(ld_iprel_i128) { return core.read_ip_relative<u128> (as); }
...
DEFINE_INSN_IMPLEMENTATION(ld_xi64_i128) { return core.read_indexed<u128,  i64>(as); }
...
DEFINE_INSN_IMPLEMENTATION(ld_xi32_i128) { return core.read_indexed<u128,  i32>(as); }
...
DEFINE_INSN_IMPLEMENTATION(ld_xu32_i128) { return core.read_indexed<u128,  u32>(as); }
...
DEFINE_INSN_IMPLEMENTATION_NOMEM(sll_imm_u64) { return core.BinaryRegShamt< u64, shift_left_immediate      > (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(srl_imm_u64) { return core.BinaryRegShamt< u64, shift_right_immediate     > (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(sra_imm_i64) { return core.BinaryRegShamt< i64, shift_right_immediate     > (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(srd_imm_i64) { return core.BinaryRegShamt< i64, shift_right_div_immediate > (); }

DEFINE_INSN_IMPLEMENTATION_NOMEM(sll_imm_u32) { return core.BinaryRegShamt< u32, shift_left_immediate      > (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(srl_imm_u32) { return core.BinaryRegShamt< u32, shift_right_immediate     > (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(sra_imm_i32) { return core.BinaryRegShamt< i32, shift_right_immediate     > (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(srd_imm_i32) { return core.BinaryRegShamt< i32, shift_right_div_immediate > (); }

DEFINE_INSN_IMPLEMENTATION_NOMEM(sll_imm_u128) { return core.BinaryRegShamt< u128, shift_left_immediate    > (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(srl_imm_u128) { return core.BinaryRegShamt< u128, shift_right_immediate   > (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(sra_imm_i128) { return core.BinaryRegShamt< i128, shift_right_immediate   > (); }
...
DEFINE_INSN_IMPLEMENTATION_NOMEM(dep_i128)
{
    const GeneralRegister& b = core.rb();
    const GeneralRegister& c = core.rc();
...
DEFINE_INSN_IMPLEMENTATION_NOMEM(cmov_eq_i32) { return core.ConditionalMove<i32, cmp_eq>(); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(cmov_lt_i32) { return core.ConditionalMove<i32, cmp_lt>(); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(cmov_le_i32) { return core.ConditionalMove<i32, cmp_le>(); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(cmov_eq_i64) { return core.ConditionalMove<i64, cmp_eq>(); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(cmov_lt_i64) { return core.ConditionalMove<i64, cmp_lt>(); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(cmov_le_i64) { return core.ConditionalMove<i64, cmp_le>(); }
...
#define BASE_SCALAR(STYPE, UTYPE) \
    ...
    DEFINE_INSN_IMPLEMENTATION_NOMEM(cmp_le_ ## STYPE) { return core.BinaryRegRegBool <STYPE, cmp_le> (); } \
    DEFINE_INSN_IMPLEMENTATION_NOMEM(cmp_lt_ ## UTYPE) { return core.BinaryRegRegBool <UTYPE, cmp_lt> (); } \
    DEFINE_INSN_IMPLEMENTATION_NOMEM(cmp_le_ ## UTYPE) { return core.BinaryRegRegBool <UTYPE, cmp_le> (); } \
    ...
    DEFINE_INSN_IMPLEMENTATION_NOMEM(cmp_gt_imm_ ## STYPE) { return core.BinaryRegSimm<STYPE, cmp_gt>(); } \
    DEFINE_INSN_IMPLEMENTATION_NOMEM(cmp_lt_imm_ ## UTYPE) { return core.BinaryRegSimm<UTYPE, cmp_lt>(); } \
    DEFINE_INSN_IMPLEMENTATION_NOMEM(cmp_gt_imm_ ## UTYPE) { return core.BinaryRegSimm<UTYPE, cmp_gt>(); } \
    ...
    DEFINE_INSN_IMPLEMENTATION(br_le_ ## STYPE) { return core.CompareRegRegAndBranch<STYPE, cmp_le>(as); } \
    DEFINE_INSN_IMPLEMENTATION(br_lt_ ## UTYPE) { return core.CompareRegRegAndBranch<UTYPE, cmp_lt>(as); } \
    DEFINE_INSN_IMPLEMENTATION(br_le_ ## UTYPE) { return core.CompareRegRegAndBranch<UTYPE, cmp_le>(as); } \
    ...
    DEFINE_INSN_IMPLEMENTATION_NOMEM(nul_le_ ## STYPE) { return core.NullifyConditionallyRegReg<STYPE, cmp_le>(); } \
    DEFINE_INSN_IMPLEMENTATION_NOMEM(nul_le_ ## UTYPE) { return core.NullifyConditionallyRegReg<UTYPE, cmp_le>(); } \
    ...
    DEFINE_INSN_IMPLEMENTATION_NOMEM(nul_gt_imm_ ## STYPE) { return core.NullifyConditionallyRegSimm<STYPE, cmp_gt>(); } \
    DEFINE_INSN_IMPLEMENTATION_NOMEM(nul_lt_imm_ ## UTYPE) { return core.NullifyConditionallyRegSimm<UTYPE, cmp_lt>(); } \
    DEFINE_INSN_IMPLEMENTATION_NOMEM(nul_gt_imm_ ## UTYPE) { return core.NullifyConditionallyRegSimm<UTYPE, cmp_gt>(); } \
    DEFINE_PSEUDO(cmp_gt_ ## STYPE) \
    DEFINE_PSEUDO(cmp_gt_ ## UTYPE) \
    DEFINE_PSEUDO(cmp_ge_ ## STYPE) \
    DEFINE_PSEUDO(cmp_ge_ ## UTYPE) \
    DEFINE_PSEUDO(cmp_ge_imm_ ## STYPE) \
    DEFINE_PSEUDO(cmp_ge_imm_ ## UTYPE) \
    DEFINE_PSEUDO(cmp_le_imm_ ## STYPE) \
    DEFINE_PSEUDO(cmp_le_imm_ ## UTYPE) \
    DEFINE_PSEUDO(br_gt_ ## STYPE) \
    DEFINE_PSEUDO(br_gt_ ## UTYPE) \
    DEFINE_PSEUDO(br_ge_ ## STYPE) \
    DEFINE_PSEUDO(br_ge_ ## UTYPE) \
    DEFINE_PSEUDO(br_le_imm_ ## STYPE) \
    DEFINE_PSEUDO(br_le_imm_ ## UTYPE) \
    DEFINE_PSEUDO(br_gt_imm_ ## STYPE) \
    DEFINE_PSEUDO(br_gt_imm_ ## UTYPE) \
