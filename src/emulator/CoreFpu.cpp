...
#define FP_BASE_SCALAR(NAME, TYPE) \
    ...
    DEFINE_INSN_IMPLEMENTATION_NOMEM(trunk_         ## NAME) { return core.ScalarOp2RoundingMode < TYPE, TYPE, frnd > (fpu::RM_RTZ); } \
    ...
    DEFINE_INSN_IMPLEMENTATION_NOMEM(cmp_ole_       ## NAME) { return core.FpScalarCompare<TYPE, fcmp_ole>(); } \
    ...
    DEFINE_INSN_IMPLEMENTATION_NOMEM(cmp_ule_       ## NAME) { return core.FpScalarCompare<TYPE, fcmp_ule>(); } \
    ...
    DEFINE_INSN_IMPLEMENTATION_NOMEM(trunk_ ## NAME ## _i32 ) { return core.ScalarOp2RoundingMode <  i32, TYPE, cvt_f_i> (fpu::RM_RTZ); } \
    DEFINE_INSN_IMPLEMENTATION_NOMEM(trunk_ ## NAME ## _u32 ) { return core.ScalarOp2RoundingMode <  u32, TYPE, cvt_f_i> (fpu::RM_RTZ); } \
    DEFINE_INSN_IMPLEMENTATION_NOMEM(trunk_ ## NAME ## _i64 ) { return core.ScalarOp2RoundingMode <  i64, TYPE, cvt_f_i> (fpu::RM_RTZ); } \
    DEFINE_INSN_IMPLEMENTATION_NOMEM(trunk_ ## NAME ## _u64 ) { return core.ScalarOp2RoundingMode <  u64, TYPE, cvt_f_i> (fpu::RM_RTZ); } \
    DEFINE_INSN_IMPLEMENTATION_NOMEM(trunk_ ## NAME ## _i128) { return core.ScalarOp2RoundingMode < i128, TYPE, cvt_f_i> (fpu::RM_RTZ); } \
    DEFINE_INSN_IMPLEMENTATION_NOMEM(trunk_ ## NAME ## _u128) { return core.ScalarOp2RoundingMode < u128, TYPE, cvt_f_i> (fpu::RM_RTZ); } \
...
#define FP_BASE_BRANCH_SCALAR(NAME, TYPE) \
    ...
    DEFINE_INSN_IMPLEMENTATION      (br_ole_     ## NAME) { return core.FpBranchOnCompare<TYPE, fcmp_ole>(as); } \
    ...
    DEFINE_INSN_IMPLEMENTATION      (br_ule_     ## NAME) { return core.FpBranchOnCompare<TYPE, fcmp_ule>(as); } \
    DEFINE_INSN_IMPLEMENTATION      (br_u_       ## NAME) { return core.FpBranchOnCompare<TYPE, fcmp_u  >(as); } \
    DEFINE_INSN_IMPLEMENTATION      (br_class_   ## NAME) { return core.FpBranchOnClassify<TYPE>(as); } \
    ...
    DEFINE_INSN_IMPLEMENTATION_NOMEM(nul_ole_    ## NAME) { return core.FpNullifyOnCompare<TYPE, fcmp_ole>(); } \
    ...
    DEFINE_INSN_IMPLEMENTATION_NOMEM(nul_ule_    ## NAME) { return core.FpNullifyOnCompare<TYPE, fcmp_ule>(); } \
    DEFINE_INSN_IMPLEMENTATION_NOMEM(nul_u_      ## NAME) { return core.FpNullifyOnCompare<TYPE, fcmp_u  >(); } \
    DEFINE_INSN_IMPLEMENTATION_NOMEM(nul_class_  ## NAME) { return core.FpNullifyOnClassify<TYPE>(); } \
...
#define FP_BASE_VECTOR(NAME, INAME, TYPE, INTTYPE, UINTTYPE) \
    ...
    DEFINE_INSN_IMPLEMENTATION_NOMEM(cmp_ole_       ## NAME) { return core.FpVectorCompare<INTTYPE, TYPE, fcmp_ole>(); } \
    ...
    DEFINE_INSN_IMPLEMENTATION_NOMEM(cmp_ule_       ## NAME) { return core.FpVectorCompare<INTTYPE, TYPE, fcmp_ule>(); } \
    ...
    DEFINE_INSN_IMPLEMENTATION_NOMEM(trunk_         ## NAME) { return core.VectorOp2RoundingMode < TYPE, TYPE, frnd > (fpu::RM_RTZ); } \
    ...
    DEFINE_INSN_IMPLEMENTATION_NOMEM(trunk_ ## NAME  ## _vu ## INAME) { return core.VectorOp2RoundingMode<UINTTYPE, TYPE, cvt_f_i>(fpu::RM_RTZ); } \
    DEFINE_INSN_IMPLEMENTATION_NOMEM(trunk_ ## NAME  ## _vi ## INAME) { return core.VectorOp2RoundingMode< INTTYPE, TYPE, cvt_f_i>(fpu::RM_RTZ); } \
