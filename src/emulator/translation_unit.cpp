...
CStatus
TranslationUnit::SetConfig(u64 value)
{
    m_Valid                = (value >> 0) & 1U;
    m_NumberOfPagingLevels = (value >> 1) & util::makemask(4);
    m_BitsPerPageOffset    = (value >> 5) & util::makemask(4);
    m_RootPageAddress      = CPhysAddress(value & ~util::makemask(12));
    return CStatus::continue_execution;
}

void
TranslationUnit::SetPagingParameters(CPhysAddress pta,
...
bool
TranslationUnit::IsSamePage(u64 p1, u64 p2) const
{
