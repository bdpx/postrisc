...
class shift_right_div { public: template<typename T> static T func(T a, T b) { b &= (8*sizeof(T)-1); return a / (T(1) << b); }};
...
class shift_right_div_immediate { public: template<typename T> static T func(T a, unsigned b) { return a / (T(1) << b); }};
class bit_set_immediate         { public: template<typename T> static T func(T a, unsigned b) { return a | (T(1) << b); }};
class bit_clear_immediate       { public: template<typename T> static T func(T a, unsigned b) { return a & ~(T(1) << b); }};
class bit_flip_immediate        { public: template<typename T> static T func(T a, unsigned b) { return a ^ (T(1) << b); }};
...
class cmp_mask_any    { public: template<typename T> static bool func(T x, T y) { return (x & y) != T(0); }};
class cmp_mask_none   { public: template<typename T> static bool func(T x, T y) { return (x & y) == T(0); }};
...
template<typename T> inline T srd(T val, unsigned int shamt) { return val / (T(1) << shamt); }
