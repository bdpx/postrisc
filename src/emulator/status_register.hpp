...
public:
    ...
    void SetIsLastInstructionInBundle(bool v = true) { isLastInstructionInBundle = v; }
...
ALWAYS_INLINE
CProcessorStatusRegister::CProcessorStatusRegister(void)
    : isLastInstructionInBundle(false)
    , flags(FLAG_CURRENT_PRIVILEGY_LEVEL) // start in kernel mode
    , ri(0)
    , future(0)
{}
