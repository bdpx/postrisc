...
CStatus
Device::read(const CDeviceOffset UNUSED(device_offset), size_t UNUSED(len), void *UNUSED(bytes)) const
{
...
CStatus
Device::read_config_raw(const CDeviceOffset device_offset, void const *config, size_t config_size, size_t len, void *bytes) const
{
