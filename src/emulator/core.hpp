...
private:
    ...
    template<class T, class OP> CStatus fetch_and_op_atomic(IAddressSpace& as, std::memory_order, std::memory_order fail_order);
    template<class T, class OP> CStatus store_op_atomic(IAddressSpace& as, std::memory_order);
    template<class T> CStatus compare_and_swap(IAddressSpace& as, std::memory_order order, std::memory_order fail_order);
