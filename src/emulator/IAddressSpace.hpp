...
public:
    ...
    virtual CStatus bus_read_u8  (const CPhysAddress address, u8& value) = 0;
    virtual CStatus bus_read_u16 (const CPhysAddress address, u16& value) = 0;
    virtual CStatus bus_read_u32 (const CPhysAddress address, u32& value) = 0;
    virtual CStatus bus_read_u64 (const CPhysAddress address, u64& value) = 0;
    virtual CStatus bus_read_u128(const CPhysAddress address, u128& value) = 0;
    virtual CStatus bus_read     (const CPhysAddress address, size_t len, void *data) = 0;
    ...
    virtual CStatus mmu_read_u8  (Core& core, const CVirtAddress va, u8& value) = 0;
    virtual CStatus mmu_read_u16 (Core& core, const CVirtAddress va, u16& value) = 0;
    virtual CStatus mmu_read_u32 (Core& core, const CVirtAddress va, u32& value) = 0;
    virtual CStatus mmu_read_u64 (Core& core, const CVirtAddress va, u64& value) = 0;
    virtual CStatus mmu_read_u128(Core& core, const CVirtAddress va, u128& value) = 0;
    virtual CStatus mmu_read     (Core& core, const CVirtAddress va, size_t len, void *data) = 0;
    ...
    virtual CStatus mmu_write     (Core& core, const CVirtAddress va, size_t len, const void *data) = 0;

    virtual CStatus mmu_read_u32_finalized(Core& core, const CVirtAddress va, u32& value) = 0;
    virtual CStatus mmu_read_u64_finalized(Core& core, const CVirtAddress va, u64& value) = 0;

    virtual CStatus mmu_read_backing_store(Core& core, const CVirtAddress va, size_t len, void *data) = 0;
    ...
    CStatus mmu_read(Core& core, const CVirtAddress va,   u8* value) { return mmu_read_u8  (core, va, *value); }
    CStatus mmu_read(Core& core, const CVirtAddress va,  u16* value) { return mmu_read_u16 (core, va, *value); }
    CStatus mmu_read(Core& core, const CVirtAddress va,  u32* value) { return mmu_read_u32 (core, va, *value); }
    CStatus mmu_read(Core& core, const CVirtAddress va,  u64* value) { return mmu_read_u64 (core, va, *value); }
    CStatus mmu_read(Core& core, const CVirtAddress va, u128* value) { return mmu_read_u128(core, va, *value); }

    CStatus mmu_read(Core& core, const CVirtAddress va,   i8* value) { return mmu_read_u8  (core, va, *(u8  *)value); }
    CStatus mmu_read(Core& core, const CVirtAddress va,  i16* value) { return mmu_read_u16 (core, va, *(u16 *)value); }
    CStatus mmu_read(Core& core, const CVirtAddress va,  i32* value) { return mmu_read_u32 (core, va, *(u32 *)value); }
    CStatus mmu_read(Core& core, const CVirtAddress va,  i64* value) { return mmu_read_u64 (core, va, *(u64 *)value); }
    CStatus mmu_read(Core& core, const CVirtAddress va, i128* value) { return mmu_read_u128(core, va, *(u128*)value); }
    ...
    u64 get_page_number(u64 address) { return address >> m_page_bits; }

protected:
    Decoder&   m_decoder; // stores address/names database
...
#define STANDARD_ADDRESS_SPACE_INTERFACE                                                                   \
    CStatus bus_read_u8(const CPhysAddress address, u8& value) override;                                   \
    CStatus bus_read_u16(const CPhysAddress address, u16& value) override;                                 \
    CStatus bus_read_u32(const CPhysAddress address, u32& value) override;                                 \
    CStatus bus_read_u64(const CPhysAddress address, u64& value) override;                                 \
    CStatus bus_read_u128(const CPhysAddress address, u128& value) override;                               \
    CStatus bus_read(const CPhysAddress address, size_t len, void* bytes) override;                        \
