...
DEFINE_INSN_IMPLEMENTATION_NOMEM(slsubfws) { return core.fused_reg_reg_shamt<i32, shifted_subtract_rev>(); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(slsubfwz) { return core.fused_reg_reg_shamt<u32, shifted_subtract_rev>(); }
...
DEFINE_INSN_IMPLEMENTATION_NOMEM(cmpqlt)  {   return core.BinaryRegRegBool < i128, cmp_lt> (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(cmpqle)  {   return core.BinaryRegRegBool < i128, cmp_le> (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(cmpqltu) {   return core.BinaryRegRegBool < u128, cmp_lt> (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(cmpqleu) {   return core.BinaryRegRegBool < u128, cmp_le> (); }
...
DEFINE_INSN_IMPLEMENTATION_NOMEM(mulwsi) {   return core.BinaryRegSimm< i32, mul         > (); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(mulwzi) {   return core.BinaryRegSimm< u32, mul         > (); }
...
DEFINE_INSN_IMPLEMENTATION(jmptws) { return core.tabular_branch<i32>(as); }
DEFINE_INSN_IMPLEMENTATION(jmptwz) { return core.tabular_branch<u32>(as); }
...
DEFINE_INSN_IMPLEMENTATION_NOMEM(cmovweq) { return core.ConditionalMove<i32, cmp_eq>(); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(cmovwlt) { return core.ConditionalMove<i32, cmp_lt>(); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(cmovwle) { return core.ConditionalMove<i32, cmp_le>(); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(cmovdeq) { return core.ConditionalMove<i64, cmp_eq>(); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(cmovdlt) { return core.ConditionalMove<i64, cmp_lt>(); }
DEFINE_INSN_IMPLEMENTATION_NOMEM(cmovdle) { return core.ConditionalMove<i64, cmp_le>(); }
...
DEFINE_PSEUDO(cmpqgt)
DEFINE_PSEUDO(cmpqgtu)
DEFINE_PSEUDO(cmpqge)
DEFINE_PSEUDO(cmpqgeu)
DEFINE_PSEUDO(bdgt)
DEFINE_PSEUDO(bdgtu)
DEFINE_PSEUDO(bdge)
DEFINE_PSEUDO(bdgeu)
