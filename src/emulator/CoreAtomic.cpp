...
DEFINE_INSN_IMPLEMENTATION(amx_ld_i8)   { return core.atomic_load<  i8>(as, std::memory_order_relaxed); }
DEFINE_INSN_IMPLEMENTATION(amq_ld_i8)   { return core.atomic_load<  i8>(as, std::memory_order_acquire); }
DEFINE_INSN_IMPLEMENTATION(amx_ld_i16)  { return core.atomic_load< i16>(as, std::memory_order_relaxed); }
DEFINE_INSN_IMPLEMENTATION(amq_ld_i16)  { return core.atomic_load< i16>(as, std::memory_order_acquire); }
DEFINE_INSN_IMPLEMENTATION(amx_ld_i32)  { return core.atomic_load< i32>(as, std::memory_order_relaxed); }
DEFINE_INSN_IMPLEMENTATION(amq_ld_i32)  { return core.atomic_load< i32>(as, std::memory_order_acquire); }
DEFINE_INSN_IMPLEMENTATION(amx_ld_i64)  { return core.atomic_load< i64>(as, std::memory_order_relaxed); }
DEFINE_INSN_IMPLEMENTATION(amq_ld_i64)  { return core.atomic_load< i64>(as, std::memory_order_acquire); }
DEFINE_INSN_IMPLEMENTATION(amx_ld_i128) { return core.atomic_load<i128>(as, std::memory_order_relaxed); }
DEFINE_INSN_IMPLEMENTATION(amq_ld_i128) { return core.atomic_load<i128>(as, std::memory_order_acquire); }
...
DEFINE_INSN_IMPLEMENTATION(amx_st_i8)   { return core.atomic_store<  i8>(as, std::memory_order_relaxed); }
DEFINE_INSN_IMPLEMENTATION(amr_st_i8)   { return core.atomic_store<  i8>(as, std::memory_order_release); }
DEFINE_INSN_IMPLEMENTATION(amx_st_i16)  { return core.atomic_store< i16>(as, std::memory_order_relaxed); }
DEFINE_INSN_IMPLEMENTATION(amr_st_i16)  { return core.atomic_store< i16>(as, std::memory_order_release); }
DEFINE_INSN_IMPLEMENTATION(amx_st_i32)  { return core.atomic_store< i32>(as, std::memory_order_relaxed); }
DEFINE_INSN_IMPLEMENTATION(amr_st_i32)  { return core.atomic_store< i32>(as, std::memory_order_release); }
DEFINE_INSN_IMPLEMENTATION(amx_st_i64)  { return core.atomic_store< i64>(as, std::memory_order_relaxed); }
DEFINE_INSN_IMPLEMENTATION(amr_st_i64)  { return core.atomic_store< i64>(as, std::memory_order_release); }
DEFINE_INSN_IMPLEMENTATION(amx_st_i128) { return core.atomic_store<i128>(as, std::memory_order_relaxed); }
DEFINE_INSN_IMPLEMENTATION(amr_st_i128) { return core.atomic_store<i128>(as, std::memory_order_release); }
...
#define DEFINE_FETCH_AND_OP_OPS(NAME, FUNC, TYPE) \
    DEFINE_INSN_IMPLEMENTATION(amx_ ## NAME ## _ ## TYPE) { return core.fetch_and_op_atomic<TYPE, FUNC>(as, std::memory_order_relaxed); } \
    DEFINE_INSN_IMPLEMENTATION(amq_ ## NAME ## _ ## TYPE) { return core.fetch_and_op_atomic<TYPE, FUNC>(as, std::memory_order_acquire); } \
    DEFINE_INSN_IMPLEMENTATION(amr_ ## NAME ## _ ## TYPE) { return core.fetch_and_op_atomic<TYPE, FUNC>(as, std::memory_order_release); } \
    DEFINE_INSN_IMPLEMENTATION(amz_ ## NAME ## _ ## TYPE) { return core.fetch_and_op_atomic<TYPE, FUNC>(as, std::memory_order_acq_rel); } \

#define DEFINE_FETCH_AND_OP_TYPES(NAME, FUNC, TYPE) \
    DEFINE_FETCH_AND_OP_OPS(NAME, FUNC, TYPE ## 8) \
    DEFINE_FETCH_AND_OP_OPS(NAME, FUNC, TYPE ## 16) \
    DEFINE_FETCH_AND_OP_OPS(NAME, FUNC, TYPE ## 32) \
    DEFINE_FETCH_AND_OP_OPS(NAME, FUNC, TYPE ## 64) \
    DEFINE_FETCH_AND_OP_OPS(NAME, FUNC, TYPE ## 128) \
...
DEFINE_FETCH_AND_OP_TYPES(ld_min,  fetch_common<min>, i)
DEFINE_FETCH_AND_OP_TYPES(ld_max,  fetch_common<max>, i)
...
DEFINE_STORE_AND_OP_TYPES(st_min,  fetch_common<min>, i)
DEFINE_STORE_AND_OP_TYPES(st_max,  fetch_common<max>, i)
