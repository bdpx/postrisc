...
public:
    ...
    CStatus mmu_read(Core& core, const CVirtAddress va, size_t len, void *data) const override;
...
template<class DerivedT>
CStatus
IManagedAddressSpace<DerivedT>::mmu_read(Core& core, const CVirtAddress va, size_t len, void *data) const
{
    LOG_DEBUG(LOG_LOAD)
        << "read: len=" << len
