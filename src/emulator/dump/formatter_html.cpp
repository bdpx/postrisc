...
void DumpFormatterHtml::dump_byte(u8 byte) const
{
    // html special chars
    switch (byte) {
        case  '<': out << "&lt;"; return;
...
void DumpFormatterHtml::dump_physical_address(u64 address) const
{
    out << "<b>" << fmt::hex(address) << "</b>";
}

void DumpFormatterHtml::dump_physical_address_ref(u64 address) const
{
...
void DumpFormatterHtml::dump_virtual_address(u64 address) const
{
    out << fmt::hex(address);
}
...
{
    out << "</pre></div></div>" << fmt::endl;
}

void DumpFormatterHtml::start_page(u64 address, dump_page_flags flags) const
{
...
void DumpFormatterHtml::finish_page(u64 UNUSED(address)) const
{
    out << "</pre></div></div>" << fmt::endl;
}

void DumpFormatterHtml::start_section(void) const
{
    out << "<div><pre>";
}

void DumpFormatterHtml::finish_section(void) const
{
