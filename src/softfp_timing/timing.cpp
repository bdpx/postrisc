...
class fadd    { public: template<typename T, typename FPU> static T func(FPU& fpu, T a, T b     ) { return fpu.add(a, b, fpu::RM_RNE); }};
class fsub    { public: template<typename T, typename FPU> static T func(FPU& fpu, T a, T b     ) { return fpu.sub(a, b, fpu::RM_RNE); }};
class fmul    { public: template<typename T, typename FPU> static T func(FPU& fpu, T a, T b     ) { return fpu.mul(a, b, fpu::RM_RNE); }};
class fdiv    { public: template<typename T, typename FPU> static T func(FPU& fpu, T a, T b     ) { return fpu.div(a, b, fpu::RM_RNE); }};
class fmuladd { public: template<typename T, typename FPU> static T func(FPU& fpu, T a, T b, T c) { return fpu.muladd(a, b, c, fpu::RM_RNE, fpu::FLOAT_MULADD_NEGATE_NONE); }};
