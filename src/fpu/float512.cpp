...
i32 CSoftFPU::to_i32_round_to_zero( f512 a )
{
    sign_type  a_sign;
    fp_exponent_t aExp, shiftCount;
    u512    aSig;
...
i64 CSoftFPU::to_i64_round_to_zero( f512 a )
{
    sign_type  a_sign;
    fp_exponent_t aExp, shiftCount;
    u512    aSig;
...
u64 CSoftFPU::divide_step( const u512 & bSig, u576 & rem )
{
    u576 term;
