...
f32 CSoftFPU::NormalizeRoundPackTo_f32(sign_type zSign, fp_exponent_t zExp, u32 zSig)
{
    assert( zSig );
...
i32 CSoftFPU::to_i32_round_to_zero( f32 a )
{
    f32::fraction_t aSig = a.fraction();
    fp_exponent_t aExp = a.exponent();
    sign_type a_sign = a.sign();
...
i64 CSoftFPU::to_i64_round_to_zero( f32 a )
{
    f32::fraction_t aSig = a.fraction();
    fp_exponent_t  aExp = a.exponent();
    sign_type  a_sign = a.sign();
...
f32 CSoftFPU::to_f32( u32 a )
{
    return to_f32(i64(a));
}

u32 CSoftFPU::to_u32( f32 a )
{
    u32 res;
...
u32 CSoftFPU::to_u32_round_to_zero( f32 a )
{
    u32 res;
...
u16 CSoftFPU::to_u16_round_to_zero(f32 a)
{
    u16 res;
