...
i32 CSoftFPU::to_i32_round_to_zero( f128 a )
{
    f128::fraction_t aSig  = a.fraction();
    fp_exponent_t  aExp  = a.exponent();
    sign_type    a_sign = a.sign();
...
i64 CSoftFPU::to_i64_round_to_zero( f128 a )
{
    i64      z;
