...
template<class FLOAT> bool CSoftFPU::compare_ordered(FLOAT a, FLOAT b)
{
    if (a.IsNan() || b.IsNan()) {
...
template<class FLOAT> bool CSoftFPU::compare_unordered(FLOAT a, FLOAT b)
{
    if (a.IsNan() || b.IsNan()) {
        if (a.IsSignalingNan() || b.IsSignalingNan()) {
            raise(FLOAT_FLAG_INVALID);
...
template<class FLOAT> bool CSoftFPU::compare_ordered_eq(FLOAT a, FLOAT b)
{
    if (a.IsNan() || b.IsNan()) {
        if (a.IsSignalingNan() || b.IsSignalingNan()) {
            raise(FLOAT_FLAG_INVALID);
...
template<class FLOAT> bool CSoftFPU::compare_unordered_eq(FLOAT a, FLOAT b)
{
    if (a.IsNan() || b.IsNan()) {
        if (a.IsSignalingNan() || b.IsSignalingNan()) {
            raise(FLOAT_FLAG_INVALID);
...
template<class FLOAT> bool CSoftFPU::compare_ordered_ne(FLOAT a, FLOAT b)
{
    if (a.IsNan() || b.IsNan()) {
        if (a.IsSignalingNan() || b.IsSignalingNan()) {
            raise(FLOAT_FLAG_INVALID);
...
template<class FLOAT> bool CSoftFPU::compare_unordered_ne(FLOAT a, FLOAT b)
{
    if (a.IsNan() || b.IsNan()) {
        if (a.IsSignalingNan() || b.IsSignalingNan()) {
            raise(FLOAT_FLAG_INVALID);
...
template<class FLOAT> bool CSoftFPU::compare_ordered_lt(FLOAT a, FLOAT b)
{
    if (a.IsNan() || b.IsNan()) {
        if (a.IsSignalingNan() || b.IsSignalingNan()) {
            raise(FLOAT_FLAG_INVALID);
...
template<class FLOAT> bool CSoftFPU::compare_unordered_lt(FLOAT a, FLOAT b)
{
    if (a.IsNan() || b.IsNan()) {
        if (a.IsSignalingNan() || b.IsSignalingNan()) {
            raise(FLOAT_FLAG_INVALID);
...
template<class FLOAT> bool CSoftFPU::compare_ordered_le(FLOAT a, FLOAT b)
{
    if (a.IsNan() || b.IsNan()) {
        if (a.IsSignalingNan() || b.IsSignalingNan()) {
            raise(FLOAT_FLAG_INVALID);
...
template<class FLOAT> bool CSoftFPU::compare_unordered_le(FLOAT a, FLOAT b)
{
    if (a.IsNan() || b.IsNan()) {
        if (a.IsSignalingNan() || b.IsSignalingNan()) {
            raise(FLOAT_FLAG_INVALID);
