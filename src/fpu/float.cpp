...
void
CBaseFPU::set_control_word(u64 word)
{
...
void
CBaseFPU::change_control_word(u64 and_mask, u64 or_mask)
{
...
*----------------------------------------------------------------------------*/
i32
CSoftFPU::round_pack_to_i32(int_nan_mode_t bothSignedNAN, sign_type zSign, u64 absZ)
{
...
i64
CSoftFPU::round_pack_to_i64(int_nan_mode_t bothSignedNAN, sign_type zSign, u64 absZ0, u64 absZ1)
{
    i64 z;
...
u64 CSoftFPU::estimateDiv128To64( u64 a0, u64 a1, u64 b )
{
...
u32 CSoftFPU::estimateSqrt32(int aExp, u32 a)
{
