...
i32 CSoftFPU::to_i32_round_to_zero( f80 a )
{
    sign_type   a_sign;
...
i64 CSoftFPU::to_i64_round_to_zero( f80 a )
{
    sign_type   a_sign;
    fp_exponent_t aExp, shiftCount;
    f80::fraction_t  aSig;
