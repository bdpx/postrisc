...
| returned.
*----------------------------------------------------------------------------*/
i64 CSoftFPU::to_i64_round_to_zero( f64 a)
{
    sign_type  a_sign;
    fp_exponent_t aExp, shiftCount;
    f64::fraction_t  aSig;
...
i32 CSoftFPU::to_i32_round_to_zero( f64 a)
{
    i32    z, shiftCount;
...
f64 CSoftFPU::to_f64(u32 a)
{
    return to_f64(i64(a));
}

u32 CSoftFPU::to_u32( f64 a)
{
    u32 res;
...
u32 CSoftFPU::to_u32_round_to_zero( f64 a)
{
    u32 res;
...
u16 CSoftFPU::to_u16_round_to_zero(f64 a)
{
    u16 res;
...
u64 CSoftFPU::to_u64_round_to_zero (f64 a)
{
    i64 v;
