...
#if defined(WINDOWS) // no f128 builtins
#    if defined(__clang__) // no quadmath, no builtins
#        error "clang doesn't support quadmath"
#    else // gcc supports f128 lib via quadmath
#        include <quadmath.h>
#        define F128_FUNC_NAME(name) name ## q
#    endif
#else // both gcc and clang support f128 natively via builtins
#    define F128_FUNC_NAME(name) __builtin_ ## name ## f128
#endif
