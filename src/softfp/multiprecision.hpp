...
template<class wrapper, size_t BITS_PER_FLOAT, size_t BITS_PER_EXPONENT>
class float_base {
public:
...
class ieee_float<8, BITS_PER_EXPONENT> : public float_base<uint8_t, 8, BITS_PER_EXPONENT>
{
private:
    scalar_uint<uint8_t> value;
};

template<size_t BITS_PER_EXPONENT>
class ieee_float<16, BITS_PER_EXPONENT> : public float_base<uint16_t, 16, BITS_PER_EXPONENT>
{
private:
    scalar_uint<uint16_t> value;
};

template<size_t BITS_PER_EXPONENT>
class ieee_float<32, BITS_PER_EXPONENT> : public float_base<uint32_t, 32, BITS_PER_EXPONENT>
{
private:
    scalar_uint<uint32_t> value;
};

template<size_t BITS_PER_EXPONENT>
class ieee_float<64, BITS_PER_EXPONENT> : public float_base<uint64_t, 64, BITS_PER_EXPONENT>
{
private:
    scalar_uint<uint64_t> value;
};
