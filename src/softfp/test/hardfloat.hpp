 ...
 */
inline void __fnldcw(uint16_t cw, uint16_t newcw)
{
    fp_env_t  env;
    uint16_t    sw;
...
class CHardFPU : public CBaseFPU
{
public:
...
//    void set_flush_to_zero(bool val);
    ...
    f32  to_f32 ( int32_t a ) {  return f32 ( float    ( a ) ); }
    f64  to_f64 ( int32_t a ) {  return f64 ( double   ( a ) ); }
    f80  to_f80 ( int32_t a ) {  return f80 ( extended ( a ) ); }
    f128 to_f128( int32_t a ) {  return f128( quadruple( a ) ); }

    f32  to_f32 ( int64_t a ) {  return f32 ( float    ( a )); }
    f64  to_f64 ( int64_t a ) {  return f64 ( double   ( a )); }
    f80  to_f80 ( int64_t a ) {  return f80 ( extended ( a )); }
    f128 to_f128( int64_t a ) {  return f128( quadruple( a )); }

    f64  to_f64 ( f32  a ) {  return f64 ( double   ( a.hard() )); }
    f80  to_f80 ( f32  a ) {  return f80 ( extended ( a.hard() )); }
    f128 to_f128( f32  a ) {  return f128( quadruple( a.hard() )); }
    f32  to_f32 ( f64  a ) {  return f32 ( float    ( a.hard() )); }
    f80  to_f80 ( f64  a ) {  return f80 ( extended ( a.hard() )); }
    f128 to_f128( f64  a ) {  return f128( quadruple( a.hard() )); }
    f32  to_f32 ( f80  a ) {  return f32 ( float    ( a.hard() )); }
    f64  to_f64 ( f80  a ) {  return f64 ( double   ( a.hard() )); }
    f128 to_f128( f80  a ) {  return f128( quadruple( a.hard() )); }
    f32  to_f32 ( f128 a ) {  return f32 ( float    ( a.hard() )); }
    f64  to_f64 ( f128 a ) {  return f64 ( double   ( a.hard() )); }
    f80  to_f80 ( f128 a ) {  return f80 ( extended ( a.hard() )); }

    // use current rounding mode (rint-like functions)
    int32_t to_i32( f32  a ) {  return   rintf( a.hard() ); } // cant fint i32rint
    int64_t to_i64( f32  a ) {  return llrintf( a.hard() ); }
    int32_t to_i32( f64  a ) {  return   rint ( a.hard() ); } // cant fint i32rint
    int64_t to_i64( f64  a ) {  return llrint ( a.hard() ); }
    int32_t to_i32( f80  a ) {  return   rintl( a.hard() ); } // cant fint i32rint
    int64_t to_i64( f80  a ) {  return llrintl( a.hard() ); }
    int32_t to_i32( f128 a ) {  return   (int32_t)mpfr::rint( a.hard() ); } // cant fint i32rint
    int64_t to_i64( f128 a ) {  return   (int64_t)mpfr::rint( a.hard() ); }

    // C++ always convert float to int by rounding toward zero, so we just return
    int16_t to_i16_round_to_zero( f32  a ) {  return a.hard(); }
    int32_t to_i32_round_to_zero( f32  a ) {  return a.hard(); }
    int64_t to_i64_round_to_zero( f32  a ) {  return a.hard(); }
    int32_t to_i32_round_to_zero( f64  a ) {  return a.hard(); }
    int64_t to_i64_round_to_zero( f64  a ) {  return a.hard(); }
    int32_t to_i32_round_to_zero( f80  a ) {  return a.hard(); }
    int64_t to_i64_round_to_zero( f80  a ) {  return a.hard(); }
    int32_t to_i32_round_to_zero( f128 a ) {  return a.hard(); }
    int64_t to_i64_round_to_zero( f128 a ) {  return a.hard(); }

    // use current rounding mode (rint-like functions)
    f32  round_to_int( f32  a ) {  return f32 ( rintf( a.hard() ) ); }
    f64  round_to_int( f64  a ) {  return f64 ( rint ( a.hard() ) ); }
    f80  round_to_int( f80  a ) {  return f80 ( rintl( a.hard() ) ); }
    f128 round_to_int( f128 a ) {  return f128( (int64_t)mpfr::rint( a.hard() ) ); }
    ...
    f32 add( f32 a, f32 b ) {  return f32( a.hard() + b.hard() ); }
    f32 sub( f32 a, f32 b ) {  return f32( a.hard() - b.hard() ); }
    f32 mul( f32 a, f32 b ) {  return f32( a.hard() * b.hard() ); }
    f32 div( f32 a, f32 b ) {  return f32( a.hard() / b.hard() ); }

    f64 add( f64 a, f64 b ) {  return f64( a.hard() + b.hard() ); }
    f64 sub( f64 a, f64 b ) {  return f64( a.hard() - b.hard() ); }
    f64 mul( f64 a, f64 b ) {  return f64( a.hard() * b.hard() ); }
    f64 div( f64 a, f64 b ) {  return f64( a.hard() / b.hard() ); }

    f80 add( f80 a, f80 b ) {  return f80( a.hard() + b.hard() ); }
    f80 sub( f80 a, f80 b ) {  return f80( a.hard() - b.hard() ); }
    f80 mul( f80 a, f80 b ) {  return f80( a.hard() * b.hard() ); }
    f80 div( f80 a, f80 b ) {  return f80( a.hard() / b.hard() ); }

    f128 add( f128 a, f128 b ) {  return f128( a.hard() + b.hard() ); }
    f128 sub( f128 a, f128 b ) {  return f128( a.hard() - b.hard() ); }
    f128 mul( f128 a, f128 b ) {  return f128( a.hard() * b.hard() ); }
    f128 div( f128 a, f128 b ) {  return f128( a.hard() / b.hard() ); }

    f32 exp2( f32 a ) { return f32( ::exp2f( a.hard() ) ); }
    f64 exp2( f64 a ) { return f64( ::exp2 ( a.hard() ) ); }
    f80 exp2( f80 a ) { return f80( ::exp2l( a.hard() ) ); }
//    f128 exp2( f128 a ) { f128 z;  z.hard() = ::exp2q( a.hard() );   return z; }

    f32  log2( f32  a ) { return f32 ( ::log2f( a.hard() ) ); }
    f64  log2( f64  a ) { return f64 ( ::log2 ( a.hard() ) ); }
    f80  log2( f80  a ) { return f80 ( ::log2l( a.hard() ) ); }
    f128 log2( f128 a ) { return f128( (quadruple)mpfr::log2( a.hard() ) ); }

    f32  sqrt( f32 a ) { return f32( ::sqrtf( a.hard() ) ); }
    f64  sqrt( f64 a ) { return f64( ::sqrt ( a.hard() ) ); }
    f80  sqrt( f80 a ) { return f80( ::sqrtl( a.hard() ) ); }
    f128 sqrt( f128 a ) { return f128( (quadruple)mpfr::sqrt( a.hard() ) ); }

    f32  rem( f32  a, f32  b ) {  return f32 ( remainderf( a.hard(), b.hard() ) ); }
    f64  rem( f64  a, f64  b ) {  return f64 ( remainder ( a.hard(), b.hard() ) ); }
    f80  rem( f80  a, f80  b ) {  return f80 ( remainderl( a.hard(), b.hard() ) ); }
    f128 rem( f128 a, f128 b ) {  return f128( (quadruple)mpfr::remainder( a.hard(), b.hard() ) ); }

    f32  muladd( f32  a, f32  b, f32  c, muladd_negate_t ) {   return f32 ( fmaf( a.hard(), b.hard(), c.hard() ) ); }
    f64  muladd( f64  a, f64  b, f64  c, muladd_negate_t ) {   return f64 ( fma ( a.hard(), b.hard(), c.hard() ) ); }
    f80  muladd( f80  a, f80  b, f80  c, muladd_negate_t ) {   return f80 ( fmal( a.hard(), b.hard(), c.hard() ) ); }
    f128 muladd( f128 a, f128 b, f128 c, muladd_negate_t ) {   return f128( (quadruple)mpfr::fma( a.hard(), b.hard(), c.hard() ) ); }
};
...
inline void CHardFPU::clear_flags( void )
{
    CBaseFPU::clear_flags();
    std::feclearexcept (FE_ALL_EXCEPT);
}


inline void CHardFPU::set_rounding_mode(rounding_mode_t val)
{
    CBaseFPU::set_rounding_mode(val);
...
inline float_flag CHardFPU::get_flags(void) const
{
    fexcept_t hw_flags;
...
inline void CHardFPU::set_rounding_precision(rounding_precision_t val)
{
    x87::fp_prec_t mode;
    switch (val) {
        default:
