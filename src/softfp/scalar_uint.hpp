...
static_assert(sizeof(scalar_uint<uint8_t>) == sizeof(uint8_t));
static_assert(sizeof(scalar_uint<uint16_t>) == sizeof(uint16_t));
static_assert(sizeof(scalar_uint<uint32_t>) == sizeof(uint32_t));
static_assert(sizeof(scalar_uint<uint64_t>) == sizeof(uint64_t));
