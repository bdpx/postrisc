...
#define READ_TYPED_HANDLER(TYPE)                                               \
    CStatus DeviceArray::read_##TYPE(const CDeviceOffset address, TYPE& data) {   \
...
CStatus
DeviceArray::read(const CDeviceOffset device_offset, size_t len, void* bytes)
{
...
CStatus
DeviceArray::read_config(const CDeviceOffset device_offset, size_t len, void *bytes)
{
