...
CStatus device_rom::read_##TYPE(const CDeviceOffset device_offset, TYPE& data)    \
{                                                                                 \
...
CStatus
device_rom::read(const CDeviceOffset device_offset, size_t len, void * bytes)
{
    u64 const offset = device_offset.get_offset();
...
CStatus
device_rom::read_config(const CDeviceOffset device_offset, size_t len, void *bytes)
{
