...
CStatus device_memory::read_##TYPE(const CDeviceOffset device_offset, TYPE& data)   \
{                                                                                   \
...
CStatus
device_memory::read(const CDeviceOffset device_offset, size_t len, void* bytes)
{
...
CStatus
device_memory::read_config(const CDeviceOffset device_offset, size_t len, void *bytes)
{
