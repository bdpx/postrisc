...
FORTRAN_FUNCTION void TRACE(char (*name)[8]);
FORTRAN_FUNCTION void SPACE();
FORTRAN_FUNCTION void TEST(long*);
FORTRAN_FUNCTION void TRACK(char (*name)[8]);
...
CALLED_FROM_FORTRAN void KERNEL(double TK[6])
{
