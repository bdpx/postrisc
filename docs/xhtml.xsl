...
<xsl:template match="doc:stride">           <td class="imm" colspan="7">   <xsl:apply-templates/> </td> </xsl:template>
<xsl:template match="doc:stride_low">       <td class="imm" colspan="3">   <xsl:apply-templates/> </td> </xsl:template>
...
<xsl:template match="doc:rounding_mode">    <td class="mod" colspan="3">   <xsl:apply-templates/> </td> </xsl:template>
<xsl:template match="doc:memory_ordering">  <td class="mod" colspan="3">   <xsl:apply-templates/> </td> </xsl:template>
...
<xsl:template match="doc:r3reserved">       <td class="res" colspan="21">  <xsl:apply-templates/> </td> </xsl:template>
