...
<div class="chapter">
<br/><br/><hr/>
<p class="copyright">POSTRISC 64-bit virtual processor.</p>
...
<p class="copyright">
    <a href="https://validator.w3.org/check?uri=https://bdpx.github.io/postrisc/index.html">
...
<xsl:template match="doc:section/doc:title">
  ...
  <xsl:text>&#167; </xsl:text><xsl:number count="doc:chapter|doc:section" level="multiple" format="1.1. "/>
  <xsl:apply-templates/>
  </h2>
</xsl:template>
...
<xsl:template match="doc:subsection/doc:title">
  ...
  <xsl:text>&#167; </xsl:text><xsl:number count="doc:chapter|doc:section|doc:subsection" level="multiple" format="1.1.1. "/>
  <xsl:apply-templates/>
  </h3>
</xsl:template>
...
<xsl:template match="doc:table/doc:caption">
  ...
  <xsl:number count="doc:chapter" format="1."/><xsl:number count="doc:table" from="doc:chapter" level="any" format="1: "/>
  <xsl:apply-templates/>
  </caption>
</xsl:template>

<xsl:template match="doc:thead"> <thead> <xsl:apply-templates/> </thead></xsl:template>
<xsl:template match="doc:tbody"> <tbody> <xsl:apply-templates/> </tbody></xsl:template>
...
<xsl:template match="doc:idisp">            <td class="imm" colspan="9">   <xsl:apply-templates/> </td> </xsl:template>
...
<xsl:template match="doc:binimmu">          <td class="imm" colspan="21">  <xsl:apply-templates/> </td> </xsl:template>
...
<xsl:template match="doc:scale_mode">       <td class="mod" colspan="2">   <xsl:apply-templates/> </td> </xsl:template>
<xsl:template match="doc:res21">            <td class="res" colspan="21">  <xsl:apply-templates/> </td> </xsl:template>

<xsl:template match="doc:memorder">     <td class="mod" colspan="3"> <xsl:apply-templates/> </td> </xsl:template>
<xsl:template match="doc:roundmode">    <td class="mod" colspan="3"> <xsl:apply-templates/> </td> </xsl:template>
