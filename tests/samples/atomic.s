.text
    ...
    amx_cas_i8    %r12, %r5, %r56, %r34
    amq_cas_i8    %r12, %r5, %r56, %r34
    amr_cas_i8    %r12, %r5, %r56, %r34
    amz_cas_i8   %r12, %r5, %r56, %r34

    amx_cas_i16   %r12, %r5, %r56, %r34
    amq_cas_i16   %r12, %r5, %r56, %r34
    amr_cas_i16   %r12, %r5, %r56, %r34
    amz_cas_i16  %r12, %r5, %r56, %r34

    amx_cas_i32   %r12, %r5, %r56, %r34
    amq_cas_i32   %r12, %r5, %r56, %r34
    amr_cas_i32   %r12, %r5, %r56, %r34
    amz_cas_i32  %r12, %r5, %r56, %r34

    amx_cas_i64   %r12, %r5, %r56, %r34
    amq_cas_i64   %r12, %r5, %r56, %r34
    amr_cas_i64   %r12, %r5, %r56, %r34
    amz_cas_i64  %r12, %r5, %r56, %r34

    amx_cas_i128  %r12, %r5, %r56, %r34
    amq_cas_i128  %r12, %r5, %r56, %r34
    amr_cas_i128  %r12, %r5, %r56, %r34
    amz_cas_i128 %r12, %r5, %r56, %r34
