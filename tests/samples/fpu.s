...
;   jmp skipfma
    ...
    write "test rounding"
    round_f128 %r17, %r12, rtz
    write "r17     %f128(r17)"
    round_f128 %r17, %r12, rdn
    write "r17     %f128(r17)"
    round_f128 %r17, %r12, rup
    write "r17     %f128(r17)"
    round_f128 %r17, %r12, rne
    write "r17     %f128(r17)"
    cvt_f128_i32 %r17, %r12, rtz
    write "r17     %i64(r17)"
    ld_imm %r17, 123456
    cvt_i32_f128 %r17, %r7
    write "r17     %f128(r17)"
...
xxloop:
    ...
    round_f128 %r78, %r74, rmm
    round_f128 %r89, %r65, rtz
    round_f128 %r81, %r76, rdn
    round_f128 %r62, %r67, rup
    sqrt_f128 %r63, %r78
    rsqrt_f128 %r64, %r69
    ...
    cvt_f128_i32 %r56, %r45, rmm
    cvt_f128_u32 %r56, %r45, rmm
    cvt_i32_f128 %r45, %r56, rmm
    cvt_u32_f128 %r45, %r56, rmm
...
;   write "%f128(r6)"
    ...
    class_f16 %r4, %r5, 1023
    class_f32 %r4, %r5, 1023
    class_f64 %r4, %r5, 1023
    class_f128 %r4, %r5, 1023
    jmp skipfma
...
fpu_forward_target:
    ...
    round_f16 %r23, %r33, dyn
    round_f16 %r23, %r33, rne
    round_f16 %r23, %r33, rdn
    round_f16 %r23, %r33, rup
    round_f16 %r23, %r33, rtz
    round_f16 %r23, %r33, rmm

    round_f32 %r23, %r33, dyn
    round_f32 %r23, %r33, rne
    round_f32 %r23, %r33, rdn
    round_f32 %r23, %r33, rup
    round_f32 %r23, %r33, rtz
    round_f32 %r23, %r33, rmm

    round_f64 %r23, %r33, dyn
    round_f64 %r23, %r33, rne
    round_f64 %r23, %r33, rdn
    round_f64 %r23, %r33, rup
    round_f64 %r23, %r33, rtz
    round_f64 %r23, %r33, rmm

    round_f128 %r23, %r33, dyn
    round_f128 %r23, %r33, rne
    round_f128 %r23, %r33, rdn
    round_f128 %r23, %r33, rup
    round_f128 %r23, %r33, rtz
    round_f128 %r23, %r33, rmm

    roundnx_f16 %r23, %r33, dyn
    roundnx_f16 %r23, %r33, rne
    roundnx_f16 %r23, %r33, rdn
    roundnx_f16 %r23, %r33, rup
    roundnx_f16 %r23, %r33, rtz
    roundnx_f16 %r23, %r33, rmm

    roundnx_f32 %r23, %r33, dyn
    roundnx_f32 %r23, %r33, rne
    roundnx_f32 %r23, %r33, rdn
    roundnx_f32 %r23, %r33, rup
    roundnx_f32 %r23, %r33, rtz
    roundnx_f32 %r23, %r33, rmm

    roundnx_f64 %r23, %r33, dyn
    roundnx_f64 %r23, %r33, rne
    roundnx_f64 %r23, %r33, rdn
    roundnx_f64 %r23, %r33, rup
    roundnx_f64 %r23, %r33, rtz
    roundnx_f64 %r23, %r33, rmm

    roundnx_f128 %r23, %r33, dyn
    roundnx_f128 %r23, %r33, rne
    roundnx_f128 %r23, %r33, rdn
    roundnx_f128 %r23, %r33, rup
    roundnx_f128 %r23, %r33, rtz
    roundnx_f128 %r23, %r33, rmm
