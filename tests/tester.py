...
# assemble from disassembled 'out_diz.txt' to 'out_diz.o'
#${EXEFILE} --assemble <${OUTPUT_DIR}/${TEST_NAME}_diz.txt >${OUTPUT_DIR}/${TEST_NAME}_diz.bin

# assemble from disassembled 'out_dump.txt' to 'out_dump.o'
#${EXEFILE} --assemble <${OUTPUT_DIR}/${TEST_NAME}_dump.txt >${OUTPUT_DIR}/${TEST_NAME}_dump.bin
