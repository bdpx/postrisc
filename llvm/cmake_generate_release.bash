...
mkdir -p ${LLVM_BUILD_RELEASE_DIR}
echo "LLVM_BUILD_RELEASE_DIR=${LLVM_BUILD_RELEASE_DIR}"
...
declare -r CMAKE_ARGS=(
    ...
    -DCMAKE_CXX_COMPILER=clang++ # assume 19 in Debian Trixie
    -DCMAKE_C_COMPILER=clang # assume 19 in Debian Trixie
    ...
    -DCMAKE_CXX_FLAGS="-O2 -g0 -D__POSTRISC__"
    -DCMAKE_EXE_LINKER_FLAGS="-g0"
    -DCMAKE_SHARED_LINKER_FLAGS="-g0"
