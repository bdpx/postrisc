...
#  -print-records
#  -gen-dag-isel
#  --write-if-changed -o ${LLVM_BUILD_DIR}/lib/Target/Postrisc/PostriscGenDAGISel.inc 

# C:\llvm-project\build\bin\

${LLVM_BUILD_DIR}/NATIVE/bin/llvm-tblgen \
    -gen-dag-isel \
    ...
    --write-if-changed \
    -o ${LLVM_BUILD_DIR}/lib/Target/Postrisc/PostriscGenDAGISel.inc
