...
${OBJDUMP} ${OBJDUMP_OPTIONS[@]} - <main.o >main_disasm.s
${OBJDUMP} ${OBJDUMP_OPTIONS[@]} - <second.o >second_disasm.s

echo "linker: main.o second.o ==> foo.exxe"
${LINKER} ${LINKER_OPTIONS[@]} -o foo.exxe main.o second.o

echo "objdump: foo.exxe ==> foo_exxe_disasm.s"
${OBJDUMP} ${OBJDUMP_OPTIONS[@]} - <foo.exxe >foo_exxe_disasm.s
