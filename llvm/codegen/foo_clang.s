...
.Lfunc_end565:
	.size	test_nuldleu, .Lfunc_end565-test_nuldleu
	.size	.Ltest_nuldleu$local, .Lfunc_end565-test_nuldleu
                                        ! -- End function
...
! %bb.0:                                ! %entry
	...
	allocsp	5, 16
	addi	%r1, %r1, -10
	bdgeui	%r1, 6, .LBB620_9

	! BUNDLE
	ldafr	%r2, %pcfwd(.LJTI620_0)
	jmpt	%r2, %r1
	nop	0
...
! %bb.0:                                ! %entry
	...
	allocsp	5, 16
	addiws	%r2, %r1, -10
	bwgeui	%r2, 6, .LBB621_9

	! BUNDLE
	addiwz	%r1, %r1, -10
	ldafr	%r2, %pcfwd(.LJTI621_0)
	jmpt	%r2, %r1
...
! %bb.0:                                ! %entry
	...
	allocsp	5, 16
	addiws	%r2, %r1, -10
	bwgeui	%r2, 6, .LBB622_9

	! BUNDLE
	addiwz	%r1, %r1, -10
	ldafr	%r2, %pcfwd(.LJTI622_0)
	jmpt	%r2, %r1
